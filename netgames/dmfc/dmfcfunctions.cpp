...
DMFCFUNCTION int	(*DLLObjCreate)(ubyte type,ushort id,int roomnum,vector *pos,const matrix *orient,int parent_handle);
DMFCFUNCTION int	(*DLLFindObjectIDName)(char *name);
DMFCFUNCTION void	(*DLLObjSetPosNoMark)(object *objp,vector *newpos,int roomnum,matrix *orient,bool f_update_attached_children);
DMFCFUNCTION void	(*DLLObjSetPos)(object *objp,vector *newpos,int roomnum,matrix *orient,bool f_update_attached_children);
...
DMFCFUNCTION bool	(*DLLInvAddTypeID) (int pnum, int type,int id,int aux_type,int aux_id,int flags,char *description);
...
DMFCFUNCTION void	(*DLLrend_DrawScaledBitmap)(int x1,int y1,int x2,int y2,int bm,float u0,float v0,float u1,float v1,float zval,int color,float *alphas);
...
DMFCFUNCTION void	(*DLLRenderHUDQuad)(int x, int y, int w, int h, float u0, float v0, float u1, float v1, int bm, ubyte alpha,int sat_count);
...
DMFCFUNCTION void	(*DLLrend_DrawScaledChunkedBitmap)(chunked_bitmap *chunk, int x, int y, int neww, int newh, ubyte alpha);
...
DMFCFUNCTION void	(*DLLRenderHUDTextFlags)(int flags, ddgr_color col, ubyte alpha, int sat_count, int x, int y, char *fmt, ...);
...
DMFCFUNCTION bool	(*DLLApplyDamageToPlayer)(object *playerobj, object *killer, int damage_type, float damage_amount,int server_says,int weapon_id,bool playsound);
...
DMFCFUNCTION int		(*DLLDoMessageBox)(const char *title, const char *msg, int type, ddgr_color title_color,ddgr_color text_color);
...
DMFCFUNCTION void	*(*DLLHotSpotCreate)(void *parentwin, int id, int key,void *txtitemoff,void *txtitemon, int x, int y, int w, int h, int flags);
...
DMFCFUNCTION void	*(*DLLUIConsoleGadgetCreate)(void *parentid, int id, int x, int y, int font, int cols, int rows, int flags);
...
DMFCFUNCTION void (*DLLvm_SinCosToMatrix)(matrix *m,float sinp,float cosp,float sinb,float cosb,float sinh,float cosh);
...
DMFCFUNCTION void (*DLLGameRenderWorld)(object *viewer,vector *viewer_eye,int viewer_roomnum,matrix *viewer_orient,float zoom,bool rear_view);
...
DMFCFUNCTION int (*DLLfvi_QuickDistFaceList)(int init_room_index, vector *pos, float rad, fvi_face_room_list *quick_fr_list, int max_elements);
DMFCFUNCTION int (*DLLfvi_QuickDistCellList)(int init_cell_index, vector *pos, float rad, int *quick_cell_list, int max_elements);
DMFCFUNCTION int (*DLLfvi_QuickDistObjectList)(vector *pos, int init_roomnum, float rad, short *object_index_list, int max_elements, bool f_lightmap_only, bool f_only_players_and_ais, bool f_include_non_collide_objects, bool f_stop_at_closed_doors);
...
DMFCFUNCTION void (*DLLCreateRandomSparks) (int num_sparks,vector *pos,int roomnum,int which_index,float force_scalar);
DMFCFUNCTION void (*DLLCreateRandomLineSparks) (int num_sparks,vector *pos,int roomnum,ushort color,float force_scalar);
DMFCFUNCTION int (*DLLVisEffectCreateControlled)(ubyte type,object *parent,ubyte id,int roomnum,vector *pos,float lifetime,vector *velocity,int phys_flags,float size,float mass,float drag,bool isreal);
DMFCFUNCTION void (*DLLCreateRandomParticles) (int num_sparks,vector *pos,int roomnum,int bm_handle,float size,float life);
...
DMFCFUNCTION void (*DLLg3_DrawRotatedBitmap)(vector *pos,angle rot_angle,float width,float height,int bm,int color);
...
DMFCFUNCTION void (*DLLg3_DrawPlanarRotatedBitmap)(vector *pos,vector *norm,angle rot_angle,float width,float height,int bm);
DMFCFUNCTION void (*DLLPlayerStopSounds)(int slot);
DMFCFUNCTION int (*DLLFindArg)(char *which);
DMFCFUNCTION int (*DLLFireWeaponFromObject)(object *obj,int weapon_num,int gun_num, bool f_force_forward, bool f_force_target);
...
DMFCFUNCTION bool (*Inven_Add)(Inventory *inven,int type,int id,object *parent,int aux_type,int aux_id,int flags,char *description);
DMFCFUNCTION bool (*Inven_AddObject)(Inventory *inven,int object_handle,int flags,char *description);
DMFCFUNCTION bool (*Inven_AddCounterMeasure)(Inventory *inven,int id,int aux_type,int aux_id,int flags,char *description);
