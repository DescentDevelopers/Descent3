...
UIObject *(*DLLNewUIWindowCreate)(int x, int y, int w, int h, int flags);
void (*DLLNewUIWindowDestroy)(void *deswin);
void (*DLLNewUIWindowOpen)(void *deswin);
void (*DLLNewUIWindowClose)(void *deswin);
UIObject *(*DLLTextCreate)(void *parentwin, void *textitem, int x, int y, int flags);
UIObject *(*DLLEditCreate)(void *parentwin, int id, int x, int y, int w, int h, int flags);
UIObject *(*DLLButtonCreate)(void *parentwin, int id, void *titleitem, int x, int y, int w, int h, int flags);
UIObject *(*DLLListCreate)(void *parentwin, int id, int x, int y, int w, int h, int flags);
...
UIObject *(*DLLNewUIGameWindowCreate)(int x, int y, int w, int h, int flags);
void (*DLLNewUIGameWindowDestroy)(void *item);
void (*DLLNewUIGameWindowOpen)(void *item);
void (*DLLNewUIGameWindowClose)(void *item);
UIObject *(*DLLHotSpotCreate)(void *parentwin, int id, int key, void *txtitemoff, void *txtitemon, int x,
                              int y, int w, int h, int flags);
int (*DLLPollUI)(void);
void (*DLLRemoveUITextItem)(void *item);
UIItem *(*DLLCreateNewUITextItem)(const char *newtext, uint32_t color, int font);
void (*DLLRemoveUIBmpItem)(void *item);
UIItem *(*DLLCreateNewUIBmpItem)(int handle, uint8_t alpha);
UIObject *(*DLLUIConsoleGadgetCreate)(void *parentid, int id, int x, int y, int font, int cols, int rows, int flags);
void (*DLLUIConsoleGadgetputs)(void *item, const char *str);
void (*DLLNewUIWindowSetFocusOnEditGadget)(void *item, void *parent);
UIObject *(*DLLOldListCreate)(void *parentitem, int id, int x, int y, int w, int h, int flags);
...
UIObject *(*DLLOldEditCreate)(void *parentitem, int id, int x, int y, int w, int h, int flags);
...
UIObject *(*DLLSliderCreate)(void *parent, int id, int x, int y, int flags);
...
UIObject *(*DLLCheckBoxCreate)(void *parent, int id, void *title, int x, int y, int w, int h, int flags);
