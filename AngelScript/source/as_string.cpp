...
void asCString::SetLength(size_t len) { Allocate(len, true); }
...
size_t asCString::GetLength() const { return length; }
...
int asCString::Compare(const char *str) const { return Compare(str, strlen(str)); }

int asCString::Compare(const asCString &str) const { return Compare(str.AddressOf(), str.GetLength()); }
...
bool operator==(const asCString &a, const char *b) { return a.Compare(b) == 0; }

bool operator!=(const asCString &a, const char *b) { return a.Compare(b) != 0; }

bool operator==(const asCString &a, const asCString &b) { return a.Compare(b) == 0; }

bool operator!=(const asCString &a, const asCString &b) { return a.Compare(b) != 0; }

bool operator==(const char *a, const asCString &b) { return b.Compare(a) == 0; }
