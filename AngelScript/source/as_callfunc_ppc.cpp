...
asm(" .text\n"
    ...
    " stwux r1, r1, r4    \n" // Increase the stack with the needed space and store the original value in the
                              // destination
    ...
    " nop                  \n" // return value (the next instruction below).  So we have to branch from CTR instead of
                               // LR.
    ...
    "ppcArgIsDouble:             \n"
    " addis r30, r31, ha16(ppcLoadDoubleReg - address) \n" // load the base address of the jump table for double
                                                           // registers
...
int CallSystemFunction(int id, asCContext *context, void *objectPointer) {
  ...
  asASSERT((retInMemPointer != NULL && sysFunc->hostReturnInMemory) ||
