...
#define TXT_CALLING_NONCONST_METHOD_ON_TEMP                                                                            \
  "A non-const method is called on temporary object. Changes to the object may be lost."
...
#define TXT_GC_REQUIRE_ADD_REL_GC_BEHAVIOUR                                                                            \
  "A garbage collected type must have the addref, release, and all gc behaviours"
...
#define TXT_NON_POD_REQUIRE_CONSTR_DESTR_BEHAVIOUR                                                                     \
  "A non-pod value type must have the constructor and destructor behaviours"
