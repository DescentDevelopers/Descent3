...
tTextureInfo texture_info[NUM_MONITORS] = {
	{"Beam Emitter Rm",			0,		1775},
	{"EmitterRm DataTerm",		0,		50},
	{"Room 51",						0,		2},
	{"SubObs DataTerm",			0,		50},
	{"SubObs Console2",			0,		50},
	{"Emitter Generator",		0,		286},
	{"Dock Console",				0,		50},
	{"West Dock Console",		0,		50},
	{"Room 69",						0,		125},
	{"Room 82",						0,		125},
	{"Control DataTerm",			0,		50}
};
...
tMatcenInfo matcen_info[NUM_MATCENS] = {
	{"StartingDock Matcen",			0},
	{"West Dock",						0},
	{"Parts Room",						0},
	{"Con Room Matcen1",				0},
	{"Powerup Rm1",					0},
...
int	STDCALL GetCOScriptList( int **list, int **id_list )
{
	...
	static int cust_id_list[37] = { 
		ID_CUSTOM_OBJECT_10B8,
		ID_CUSTOM_OBJECT_0892,
		ID_CUSTOM_OBJECT_0891,
		ID_CUSTOM_OBJECT_0890,
		ID_CUSTOM_OBJECT_08A8,
		ID_CUSTOM_OBJECT_08A7,
		ID_CUSTOM_OBJECT_180F,
		ID_CUSTOM_OBJECT_1081,
		ID_CUSTOM_OBJECT_186D,
		ID_CUSTOM_OBJECT_08D3,
		ID_CUSTOM_OBJECT_188F,
		ID_CUSTOM_OBJECT_0888,
		ID_CUSTOM_OBJECT_204F,
		ID_CUSTOM_OBJECT_2870,
		ID_CUSTOM_OBJECT_1025,
		ID_CUSTOM_OBJECT_08A0,
		ID_CUSTOM_OBJECT_189E,
		ID_CUSTOM_OBJECT_109B,
		ID_CUSTOM_OBJECT_109D,
		ID_CUSTOM_OBJECT_409A,
		ID_CUSTOM_OBJECT_309C,
		ID_CUSTOM_OBJECT_1083,
		ID_CUSTOM_OBJECT_088A,
		ID_CUSTOM_OBJECT_188B,
		ID_CUSTOM_OBJECT_088C,
		ID_CUSTOM_OBJECT_088D,
		ID_CUSTOM_OBJECT_088E,
		ID_CUSTOM_OBJECT_2880,
		ID_CUSTOM_OBJECT_10C3,
		ID_CUSTOM_OBJECT_4089,
		ID_CUSTOM_OBJECT_406F,
		ID_CUSTOM_OBJECT_1082,
		ID_CUSTOM_OBJECT_10D5,
		ID_CUSTOM_OBJECT_10D4,
		ID_CUSTOM_OBJECT_10D6,
		ID_CUSTOM_OBJECT_0917,
		ID_CUSTOM_OBJECT_10D7
	};
		...
		case EVT_TIMER:
			{
				...
				if(event_data->id==5)
				{
					...
					{
						aLightningCreate(Object_handles[33], Object_handles[34], 0.200000f, 1.000000f, 5, Texture_indexes[14], 0.500000f, 1, 255, 255, 255, 0);
					}
					if(qObjAnimFrame(Object_handles[21])==6.000000f)
					{
						aLightningCreateGunpoints(0, 1, Object_handles[21], 0.200000f, 10.000000f, 1, Texture_indexes[15], 0.500000f, 1, 0, 255, 255, 0);
						aUserVarInc(11);
					}
					if(qObjAnimFrame(Object_handles[22])==6.000000f)
					{
						aLightningCreateGunpoints(0, 1, Object_handles[22], 0.200000f, 10.000000f, 1, Texture_indexes[15], 0.500000f, 1, 0, 255, 255, 0);
						aUserVarInc(11);
					}
					if(qObjAnimFrame(Object_handles[23])==6.000000f)
					{
						aLightningCreateGunpoints(0, 1, Object_handles[23], 0.200000f, 10.000000f, 1, Texture_indexes[15], 0.500000f, 1, 0, 255, 255, 0);
						aUserVarInc(11);
					}
					if(qObjAnimFrame(Object_handles[24])==6.000000f)
					{
						aLightningCreateGunpoints(0, 1, Object_handles[24], 0.200000f, 10.000000f, 1, Texture_indexes[15], 0.500000f, 1, 0, 255, 255, 0);
						aUserVarInc(11);
					}
					if(qObjAnimFrame(Object_handles[25])==6.000000f)
					{
						aLightningCreateGunpoints(0, 1, Object_handles[25], 0.200000f, 10.000000f, 1, Texture_indexes[15], 0.500000f, 1, 0, 255, 255, 0);
						aUserVarInc(11);
					}
					if(qObjAnimFrame(Object_handles[26])==6.000000f)
					{
						aLightningCreateGunpoints(0, 1, Object_handles[26], 0.200000f, 10.000000f, 1, Texture_indexes[15], 0.500000f, 1, 0, 255, 255, 0);
						aUserVarInc(11);
					}
					aSetLevelTimer(0.200000f, 5);
					...
					if((qUserFlag(11)==false) && (qUserFlag(12)==false) && (qUserFlag(13)==false))
					{
						...
						if((qGoalEnabled(Goal_indexes[9])==true) && (qGoalCompleted(Goal_indexes[9])==true) && (qUserFlag(17)==false))
						{
				...
				if(event_data->id==10)
				{
					...
					aTurnOnSpew(Object_handles[41], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.750000f, 0.020000f, 1.250000f, 1.250000f, 36.000000f, 1, 0);
					aTurnOnSpew(Object_handles[42], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.750000f, 0.020000f, 1.250000f, 1.250000f, 36.000000f, 1, 0);
					aTurnOnSpew(Object_handles[43], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.750000f, 0.020000f, 1.250000f, 1.250000f, 36.000000f, 1, 0);
					aTurnOnSpew(Object_handles[44], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.750000f, 0.020000f, 1.250000f, 1.250000f, 36.000000f, 1, 0);
					aTurnOnSpew(Object_handles[45], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.750000f, 0.020000f, 1.250000f, 1.250000f, 36.000000f, 1, 0);
					aTurnOnSpew(Object_handles[46], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.750000f, 0.020000f, 1.250000f, 1.250000f, 36.000000f, 1, 0);
					aTurnOnSpew(Object_handles[47], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.750000f, 0.020000f, 1.250000f, 1.250000f, 36.000000f, 1, 0);
					aTurnOnSpew(Object_handles[48], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.750000f, 0.020000f, 1.250000f, 1.250000f, 36.000000f, 1, 0);
					aTurnOnSpew(Object_handles[49], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.750000f, 0.020000f, 1.250000f, 1.250000f, 36.000000f, 1, 0);
					aTurnOnSpew(Object_handles[50], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.750000f, 0.020000f, 1.250000f, 1.250000f, 36.000000f, 1, 0);
					aTurnOnSpew(Object_handles[51], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.750000f, 0.020000f, 1.250000f, 1.250000f, 36.000000f, 1, 0);
					aTurnOnSpew(Object_handles[52], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.750000f, 0.020000f, 1.250000f, 1.250000f, 36.000000f, 1, 0);
					aTurnOnSpew(Object_handles[53], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.750000f, 0.020000f, 1.250000f, 1.250000f, 36.000000f, 1, 0);
					aTurnOnSpew(Object_handles[54], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.750000f, 0.020000f, 1.250000f, 1.250000f, 36.000000f, 1, 0);
					aTurnOnSpew(Object_handles[55], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.750000f, 0.020000f, 1.250000f, 1.250000f, 36.000000f, 1, 0);
					aTurnOnSpew(Object_handles[56], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.750000f, 0.020000f, 1.250000f, 1.250000f, 36.000000f, 1, 0);
					aTurnOnSpew(Object_handles[57], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.750000f, 0.020000f, 1.250000f, 1.250000f, 36.000000f, 1, 0);
					aTurnOnSpew(Object_handles[58], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.750000f, 0.020000f, 1.250000f, 1.250000f, 36.000000f, 1, 0);
					aTurnOnSpew(Object_handles[59], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.750000f, 0.020000f, 1.250000f, 1.250000f, 36.000000f, 1, 0);
					aTurnOnSpew(Object_handles[60], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.750000f, 0.020000f, 1.250000f, 1.250000f, 36.000000f, 1, 0);
					aTurnOnSpew(Object_handles[61], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.750000f, 0.020000f, 1.250000f, 1.250000f, 36.000000f, 1, 0);
					aTurnOnSpew(Object_handles[62], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.750000f, 0.020000f, 1.250000f, 1.250000f, 36.000000f, 1, 0);
					aSetLevelTimer(20.000000f, 10);
		...
		case EVT_COLLIDE:
			{
				...
				if((qObjIsPlayer(event_data->it_handle)==true) && (qUserFlag(10)==false))
				{
					...
					{
						if((qUserVarValueInt(3)==1) && ((qObjAnimFrame(data->me_handle)==0.000000f) || (qObjAnimFrame(data->me_handle)==5.000000f)))
						{
		...
		case EVT_COLLIDE:
			{
				...
				if(qObjIsPlayerOrPlayerWeapon(event_data->it_handle)==true)
				{
					...
					{
						if((qUserVarValueInt(3)==4) && (qObjAnimFrame(Object_handles[14])==3.000000f) && (qUserFlag(10)==false))
						{
		...
		case EVT_COLLIDE:
			{
				...
				if(qObjIsPlayerOrPlayerWeapon(event_data->it_handle)==true)
				{
					if((qUserFlag(2)==false) && (qUserFlag(3)==false) && ((qObjAnimFrame(data->me_handle)==0.000000f) || (qObjAnimFrame(data->me_handle)==20.000000f)))
					{
						if(qUserFlag(0)==0)
						{
							aUserFlagSet(0, 1);
		...
		case EVT_COLLIDE:
			{
				...
				if(qObjIsPlayerOrPlayerWeapon(event_data->it_handle)==true)
				{
					if((qUserFlag(2)==false) && (qUserFlag(4)==false) && ((qObjAnimFrame(data->me_handle)==0.000000f) || (qObjAnimFrame(data->me_handle)==20.000000f)))
					{
						if(qUserFlag(0)==0)
						{
							aUserFlagSet(0, 1);
		...
		case EVT_COLLIDE:
			{
				...
				if(qObjIsPlayerOrPlayerWeapon(event_data->it_handle)==true)
				{
					if((qUserFlag(2)==false) && (qUserFlag(5)==false) && ((qObjAnimFrame(data->me_handle)==0.000000f) || (qObjAnimFrame(data->me_handle)==20.000000f)))
					{
						if(qUserFlag(0)==0)
						{
							aUserFlagSet(0, 1);
		...
		case EVT_COLLIDE:
			{
				...
				if(qObjIsPlayerOrPlayerWeapon(event_data->it_handle)==true)
				{
					if((qUserFlag(2)==false) && (qUserFlag(6)==false) && ((qObjAnimFrame(data->me_handle)==0.000000f) || (qObjAnimFrame(data->me_handle)==20.000000f)))
					{
						if(qUserFlag(0)==0)
						{
							aUserFlagSet(0, 1);
		...
		case EVT_COLLIDE:
			{
				...
				{
					if(((qObjAnimFrame(data->me_handle)==0.000000f) || (qObjAnimFrame(data->me_handle)==12.000000f)) && (qUserVarValue(4)==1.000000f))
					{
		...
		case EVT_COLLIDE:
			{
				...
				if(qUserFlag(17)==false)
				{
					if(((qObjAnimFrame(data->me_handle)==0.000000f) || (qObjAnimFrame(data->me_handle)==12.000000f)) && (qUserVarValue(5)==1.000000f))
					{
						aObjPlayAnim(data->me_handle, 0, 2, 2.000000f, 0);
						aSoundPlayObject(Sound_indexes[0], data->me_handle, 1.000000f);
		...
		case EVT_COLLIDE:
			{
				...
				if(qUserFlag(17)==false)
				{
					if(((qObjAnimFrame(data->me_handle)==0.000000f) || (qObjAnimFrame(data->me_handle)==12.000000f)) && (qUserVarValue(6)==1.000000f))
					{
						aObjPlayAnim(data->me_handle, 0, 2, 2.000000f, 0);
						aSoundPlayObject(Sound_indexes[0], data->me_handle, 1.000000f);
		...
		case EVT_COLLIDE:
			{
				...
				if(qUserFlag(17)==false)
				{
					if(((qObjAnimFrame(data->me_handle)==0.000000f) || (qObjAnimFrame(data->me_handle)==12.000000f)) && (qUserVarValue(7)==1.000000f))
					{
						aObjPlayAnim(data->me_handle, 0, 2, 2.000000f, 0);
						aSoundPlayObject(Sound_indexes[0], data->me_handle, 1.000000f);
		...
		case EVT_COLLIDE:
			{
				...
				if(qUserFlag(17)==false)
				{
					if(((qObjAnimFrame(data->me_handle)==0.000000f) || (qObjAnimFrame(data->me_handle)==12.000000f)) && (qUserVarValue(8)==1.000000f))
					{
						aObjPlayAnim(data->me_handle, 0, 2, 2.000000f, 0);
						aSoundPlayObject(Sound_indexes[0], data->me_handle, 1.000000f);
		...
		case EVT_COLLIDE:
			{
				...
				if(qUserFlag(17)==false)
				{
					if(((qObjAnimFrame(data->me_handle)==0.000000f) || (qObjAnimFrame(data->me_handle)==12.000000f)) && (qUserVarValue(9)==1.000000f))
					{
						aObjPlayAnim(data->me_handle, 0, 2, 2.000000f, 0);
						aSoundPlayObject(Sound_indexes[0], data->me_handle, 1.000000f);
		...
		case EVT_AIN_GOALCOMPLETE:
			{
				...
				if(event_data->goal_uid==0)
				{
					...
					aTurnOnSpew(Object_handles[27], 0, 0, 0.000000f, 0.000000f, 65536, 0, 0.500000f, 0.050000f, 25.000000f, 8.000000f, 100.000000f, 1, -1);
					aRoomSetWind(Room_indexes[2], 0.000000f, 0.000000f, -1.000000f, 0.000000f);
						...
						if(qUserFlag(15)==true)
						{
							if((qUserFlag(11)==false) && (qUserFlag(12)==false) && (qUserFlag(13)==false))
							{
								if(qUserFlag(10)==true)
								{
									if(qUserFlag(2)==true)
									{
										if((qObjAnimFrame(Object_handles[21])==6.000000f) && (qObjAnimFrame(Object_handles[22])==6.000000f) && (qObjAnimFrame(Object_handles[23])==6.000000f) && (qObjAnimFrame(Object_handles[24])==6.000000f) && (qObjAnimFrame(Object_handles[25])==6.000000f) && (qObjAnimFrame(Object_handles[26])==6.000000f))
										{
											aObjPlayAnim(data->me_handle, 0, 1, 2.000000f, 0);
