		...
		case EVT_COLLIDE:
			{
				...
				if((qObjIsPlayerWeapon(event_data->it_handle)==true) && (qUserFlag(0)==true))
				{
					...
					aTurnOnSpew(Object_handles[1], -1, 8, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.150000f, 3.000000f, 2.000000f, 20.000000f, 0, -1);
					aTurnOnSpew(Object_handles[2], -1, 8, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.150000f, 3.000000f, 2.000000f, 20.000000f, 0, -1);
					aTurnOnSpew(Object_handles[3], -1, 8, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.150000f, 3.000000f, 2.000000f, 20.000000f, 0, -1);
					aTurnOnSpew(Object_handles[4], -1, 8, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.150000f, 3.000000f, 2.000000f, 20.000000f, 0, -1);
					aTurnOnSpew(Object_handles[5], -1, 8, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.150000f, 3.000000f, 2.000000f, 20.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(event_data->id==1)
				{
					...
					aTurnOnSpew(Object_handles[5], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.110000f, 8.000000f, 4.000000f, 30.000000f, 0, -1);
					aTurnOnSpew(Object_handles[4], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.110000f, 8.000000f, 4.000000f, 30.000000f, 0, -1);
					aTurnOnSpew(Object_handles[3], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.110000f, 8.000000f, 4.000000f, 30.000000f, 0, -1);
					aTurnOnSpew(Object_handles[2], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.110000f, 8.000000f, 4.000000f, 30.000000f, 0, -1);
					aTurnOnSpew(Object_handles[1], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.110000f, 8.000000f, 4.000000f, 30.000000f, 0, -1);
		...
		case EVT_COLLIDE:
			{
				...
				if((qObjIsPlayerWeapon(event_data->it_handle)==true) && (qUserFlag(1)==true))
				{
					...
					aObjPlayAnim(data->me_handle, 0, 3, 3.000000f, 0);
					aSoundPlayObject(Sound_indexes[0], data->me_handle, 1.000000f);
					aTurnOnSpew(Object_handles[7], -1, 8, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.150000f, 3.000000f, 2.000000f, 20.000000f, 0, -1);
					aTurnOnSpew(Object_handles[8], -1, 8, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.150000f, 3.000000f, 2.000000f, 20.000000f, 0, -1);
					aTurnOnSpew(Object_handles[9], -1, 8, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.150000f, 3.000000f, 2.000000f, 20.000000f, 0, -1);
					aTurnOnSpew(Object_handles[10], -1, 8, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.150000f, 3.000000f, 2.000000f, 20.000000f, 0, -1);
					aTurnOnSpew(Object_handles[11], -1, 8, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.150000f, 3.000000f, 2.000000f, 20.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(event_data->id==4)
				{
					...
					aTurnOnSpew(Object_handles[11], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.110000f, 8.000000f, 4.000000f, 30.000000f, 0, -1);
					aTurnOnSpew(Object_handles[10], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.110000f, 8.000000f, 4.000000f, 30.000000f, 0, -1);
					aTurnOnSpew(Object_handles[9], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.110000f, 8.000000f, 4.000000f, 30.000000f, 0, -1);
					aTurnOnSpew(Object_handles[8], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.110000f, 8.000000f, 4.000000f, 30.000000f, 0, -1);
					aTurnOnSpew(Object_handles[7], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.110000f, 8.000000f, 4.000000f, 30.000000f, 0, -1);
