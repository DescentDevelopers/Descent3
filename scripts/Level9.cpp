...
int	STDCALL GetCOScriptList( int **list, int **id_list )
{
	...
	static int cust_id_list[25] = { 
		...
		ID_CUSTOM_OBJECT_18D5,
		ID_CUSTOM_OBJECT_18D6,
		ID_CUSTOM_OBJECT_1030,
		ID_CUSTOM_OBJECT_1038,
		ID_CUSTOM_OBJECT_0869,
		ID_CUSTOM_OBJECT_086A,
		ID_CUSTOM_OBJECT_106E,
		ID_CUSTOM_OBJECT_106F,
		ID_CUSTOM_OBJECT_106D,
		ID_CUSTOM_OBJECT_106C,
		ID_CUSTOM_OBJECT_100F,
		ID_CUSTOM_OBJECT_0871,
		ID_CUSTOM_OBJECT_0811,
		ID_CUSTOM_OBJECT_0810,
		ID_CUSTOM_OBJECT_080E,
		ID_CUSTOM_OBJECT_0873,
		ID_CUSTOM_OBJECT_0872,
		ID_CUSTOM_OBJECT_2070,
		ID_CUSTOM_OBJECT_18AA,
		ID_CUSTOM_OBJECT_18C1,
		ID_CUSTOM_OBJECT_0948,
		ID_CUSTOM_OBJECT_0949,
		ID_CUSTOM_OBJECT_18AC,
		...
		case EVT_TIMER:
			{
				...
				if(event_data->id==11)
				{
					if((qUserVarValue(8)==2.000000f) && (qUserVarValue(9)==2.000000f) && (qUserVarValue(10)==2.000000f) && (qUserVarValue(11)==2.000000f))
					{
				...
				if(event_data->id==14)
				{
					if(((ScriptActionCtr_044 > 0)==true) && ((ScriptActionCtr_043 > 0)==true) && ((ScriptActionCtr_042 > 0)==true) && ((ScriptActionCtr_040 > 0)==true))
					{
				...
				if((15==event_data->id) && (qUserVarValue(4)==1.000000f))
				{
					if(qUserVarValue(2)<0.000000f)
					{
						...
						if(qObjShields(data->me_handle)<qUserVarValue(6))
						{
							...
							aUserVarDec(2);
							if((qObjGetDistance(data->me_handle, qPlayerClosest(data->me_handle, 0))<300.000000f) && ((ScriptActionCtr_007 > 0)==true))
							{
		...
		case EVT_USE:
			{
				...
				if(1)
				{
					if((qObjGetDistance(event_data->it_handle, Object_handles[7])<28.000000f) && (qObjAnimFrame(Object_handles[7])==5.000000f) && (qUserVarValue(8)==1.000000f))
					{
						aUserVarSet(8, 2.000000f);
						aSetObjectTimer(Object_handles[7], 0.000000f, 3);
					}
					else {
						if((qObjGetDistance(event_data->it_handle, Object_handles[6])<28.000000f) && (qObjAnimFrame(Object_handles[6])==5.000000f) && (qUserVarValue(9)==1.000000f))
						{
							aUserVarSet(9, 2.000000f);
							aSetObjectTimer(Object_handles[6], 0.000000f, 4);
						}
						else {
							if((qObjGetDistance(event_data->it_handle, Object_handles[5])<28.000000f) && (qObjAnimFrame(Object_handles[5])==5.000000f) && (qUserVarValue(10)==1.000000f))
							{
								aUserVarSet(10, 2.000000f);
								aSetObjectTimer(Object_handles[5], 0.000000f, 5);
							}
							else {
								if((qObjGetDistance(event_data->it_handle, Object_handles[4])<28.000000f) && (qObjAnimFrame(Object_handles[4])==5.000000f) && (qUserVarValue(11)==1.000000f))
								{
