...
static const char *const Object_names[NUM_OBJECT_NAMES] = {"Swamp", "Forest"};
...
static const char *const Sound_names[NUM_SOUND_NAMES] = {"AmbIslandFroggies", "AmbBugsGroundB"};
