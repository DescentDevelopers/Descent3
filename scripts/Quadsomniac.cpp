...
static const char *const Room_names[NUM_ROOM_NAMES] = {"BlueTube", "GreenTube", "YellowTube", "RedSpeedTube"};
static int Room_indexes[NUM_ROOM_NAMES];

#define NUM_TRIGGER_NAMES 8
static const char *const Trigger_names[NUM_TRIGGER_NAMES] = {"YellowStart", "GreenStart", "BlueStart", "RedStart",
...
static const char *const Sound_names[NUM_SOUND_NAMES] = {"LevSecAccelStart", "LevSecAccelRelease"};
