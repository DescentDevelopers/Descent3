...
int	STDCALL GetCOScriptList( int **list, int **id_list )
{
	...
	static int cust_id_list[36] = { 
		ID_CUSTOM_OBJECT_10FD,
		ID_CUSTOM_OBJECT_0839,
		ID_CUSTOM_OBJECT_0838,
		ID_CUSTOM_OBJECT_3026,
		ID_CUSTOM_OBJECT_0901,
		ID_CUSTOM_OBJECT_0900,
		ID_CUSTOM_OBJECT_08FF,
		ID_CUSTOM_OBJECT_20FE,
		ID_CUSTOM_OBJECT_083D,
		ID_CUSTOM_OBJECT_09E3,
		ID_CUSTOM_OBJECT_09FF,
		ID_CUSTOM_OBJECT_1904,
		ID_CUSTOM_OBJECT_08C1,
		ID_CUSTOM_OBJECT_090F,
		ID_CUSTOM_OBJECT_090E,
		ID_CUSTOM_OBJECT_0910,
		ID_CUSTOM_OBJECT_090C,
		ID_CUSTOM_OBJECT_090B,
		ID_CUSTOM_OBJECT_090A,
		ID_CUSTOM_OBJECT_2853,
		ID_CUSTOM_OBJECT_090D,
		ID_CUSTOM_OBJECT_19E2,
		ID_CUSTOM_OBJECT_09FB,
		ID_CUSTOM_OBJECT_09FC,
		ID_CUSTOM_OBJECT_09FD,
		ID_CUSTOM_OBJECT_0845,
		ID_CUSTOM_OBJECT_0846,
		ID_CUSTOM_OBJECT_0844,
		ID_CUSTOM_OBJECT_0849,
		ID_CUSTOM_OBJECT_0848,
		ID_CUSTOM_OBJECT_0847,
		ID_CUSTOM_OBJECT_084A,
		ID_CUSTOM_OBJECT_084D,
		ID_CUSTOM_OBJECT_084C,
		ID_CUSTOM_OBJECT_084B,
		...
		case EVT_LEVELSTART:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[27], 0, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.080000f, -1.000000f, 10.000000f, 80.000000f, 1, 3);
					aTurnOnSpew(Object_handles[27], 1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.080000f, -1.000000f, 10.000000f, 80.000000f, 1, 4);
					aTurnOnSpew(Object_handles[27], 2, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.080000f, -1.000000f, 10.000000f, 80.000000f, 1, 5);
					aTurnOnSpew(Object_handles[27], 0, 2, 0.000000f, 0.000000f, 0, 1, 1.000000f, 1.000000f, -1.000000f, 10.000000f, 80.000000f, 0, 6);
					aTurnOnSpew(Object_handles[27], 1, 2, 0.000000f, 0.000000f, 0, 1, 1.000000f, 1.000000f, -1.000000f, 10.000000f, 80.000000f, 0, 7);
					aTurnOnSpew(Object_handles[27], 2, 2, 0.000000f, 0.000000f, 0, 1, 1.000000f, 1.000000f, -1.000000f, 10.000000f, 80.000000f, 0, 8);
		...
		case EVT_TIMER:
			{
				...
				if(3==event_data->id)
				{
					...
					aTurnOnSpew(Object_handles[1], -1, 2, 0.000000f, 0.000000f, 65536, 0, 10.000000f, 0.150000f, -1.000000f, 20.000000f, 80.000000f, 0, 2);
				...
				if(1==event_data->id)
				{
					if(qUserFlag(2)==true)
					{
						aTurnOnSpew(Object_handles[1], -1, 7, 0.000000f, 0.000000f, 65536, 0, 10.000000f, 0.150000f, -1.000000f, 20.000000f, 80.000000f, 0, 2);
						aUserFlagSet(2, 0);
				...
				if(3==event_data->id)
				{
					...
					aTurnOnSpew(Object_handles[2], -1, 2, 0.000000f, 0.000000f, 65536, 0, 10.000000f, 0.150000f, -1.000000f, 20.000000f, 80.000000f, 0, 1);
				...
				if(2==event_data->id)
				{
					if(qUserFlag(1)==true)
					{
						aTurnOnSpew(Object_handles[2], -1, 7, 0.000000f, 0.000000f, 65536, 0, 10.000000f, 0.150000f, -1.000000f, 20.000000f, 80.000000f, 0, 1);
						aUserFlagSet(1, 0);
						aSetLevelTimer(5.000000f, 2);
						aDoorSetPos(Door_handles[3], 1.000000f);
						aDoorSetPos(Door_handles[2], 1.000000f);
				...
				if(3==event_data->id)
				{
					...
					aTurnOnSpew(Object_handles[3], -1, 2, 0.000000f, 0.000000f, 65536, 0, 10.000000f, 0.150000f, -1.000000f, 20.000000f, 80.000000f, 0, 0);
				...
				if(0==event_data->id)
				{
					if(qUserFlag(0)==true)
					{
						aTurnOnSpew(Object_handles[3], -1, 7, 0.000000f, 0.000000f, 65536, 0, 10.000000f, 0.150000f, -1.000000f, 20.000000f, 80.000000f, 0, 0);
						aUserFlagSet(0, 0);
						aSetLevelTimer(15.000000f, 0);
						aDoorSetPos(Door_handles[5], 1.000000f);
						aDoorSetPos(Door_handles[4], 1.000000f);
				...
				if(3==event_data->id)
				{
					aTurnOnSpew(Object_handles[72], -1, 7, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 9);
					aTurnOnSpew(Object_handles[73], -1, 7, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 10);
					aTurnOnSpew(Object_handles[74], -1, 7, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 11);
					aTurnOnSpew(Object_handles[75], -1, 7, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 13);
					aTurnOnSpew(Object_handles[76], -1, 7, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 14);
					aTurnOnSpew(Object_handles[77], -1, 7, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 15);
					aTurnOnSpew(Object_handles[78], -1, 7, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 17);
					aTurnOnSpew(Object_handles[79], -1, 7, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 18);
					aTurnOnSpew(Object_handles[80], -1, 7, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 19);
					aTurnOnSpew(Object_handles[81], -1, 7, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 20);
					aTurnOnSpew(Object_handles[82], -1, 7, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 22);
					aTurnOnSpew(Object_handles[83], -1, 7, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 24);
					aTurnOnSpew(Object_handles[84], -1, 7, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 25);
					aTurnOnSpew(Object_handles[85], -1, 7, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 26);
					aTurnOnSpew(Object_handles[86], -1, 7, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 27);
					aTurnOnSpew(Object_handles[87], -1, 7, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 29);
					aTurnOnSpew(Object_handles[88], -1, 7, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 30);
					aTurnOnSpew(Object_handles[89], -1, 7, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 31);
					aTurnOnSpew(Object_handles[90], -1, 7, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 33);
					aTurnOnSpew(Object_handles[91], -1, 7, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 34);
				...
				{
					aTurnOnSpew(Object_handles[62], 0, 2, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 35);
					aTurnOnSpew(Object_handles[63], 0, 2, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 36);
					aTurnOnSpew(Object_handles[64], 0, 2, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 37);
					aTurnOnSpew(Object_handles[65], 0, 2, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 38);
					aTurnOnSpew(Object_handles[66], 0, 2, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 39);
					aTurnOnSpew(Object_handles[67], 0, 2, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 40);
					aTurnOnSpew(Object_handles[68], 0, 2, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 41);
					aTurnOnSpew(Object_handles[69], 0, 2, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 42);
					aTurnOnSpew(Object_handles[70], 0, 2, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 43);
					aTurnOnSpew(Object_handles[71], 0, 2, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 0, 44);
					aTurnOnSpew(Object_handles[62], 0, 2, 0.000000f, 0.000000f, 0, 1, 3.000000f, 1.000000f, -1.000000f, 4.000000f, 20.000000f, 0, 45);
					aTurnOnSpew(Object_handles[63], 0, 2, 0.000000f, 0.000000f, 0, 1, 3.000000f, 1.000000f, -1.000000f, 4.000000f, 20.000000f, 0, 46);
					aTurnOnSpew(Object_handles[64], 0, 2, 0.000000f, 0.000000f, 0, 1, 3.000000f, 1.000000f, -1.000000f, 4.000000f, 20.000000f, 0, 47);
					aTurnOnSpew(Object_handles[65], 0, 2, 0.000000f, 0.000000f, 0, 1, 3.000000f, 1.000000f, -1.000000f, 4.000000f, 20.000000f, 0, 48);
					aTurnOnSpew(Object_handles[66], 0, 2, 0.000000f, 0.000000f, 0, 1, 3.000000f, 1.000000f, -1.000000f, 4.000000f, 20.000000f, 0, 12);
					aTurnOnSpew(Object_handles[67], 0, 2, 0.000000f, 0.000000f, 0, 1, 3.000000f, 1.000000f, -1.000000f, 4.000000f, 20.000000f, 0, 16);
					aTurnOnSpew(Object_handles[68], 0, 2, 0.000000f, 0.000000f, 0, 1, 3.000000f, 1.000000f, -1.000000f, 4.000000f, 20.000000f, 0, 21);
					aTurnOnSpew(Object_handles[69], 0, 2, 0.000000f, 0.000000f, 0, 1, 3.000000f, 1.000000f, -1.000000f, 4.000000f, 20.000000f, 0, 23);
					aTurnOnSpew(Object_handles[70], 0, 2, 0.000000f, 0.000000f, 0, 1, 3.000000f, 1.000000f, -1.000000f, 4.000000f, 20.000000f, 0, 28);
					aTurnOnSpew(Object_handles[71], 0, 2, 0.000000f, 0.000000f, 0, 1, 3.000000f, 1.000000f, -1.000000f, 4.000000f, 20.000000f, 0, 32);
