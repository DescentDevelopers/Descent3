...
bool qSecurityCameraAlerted(int obj_handle)
{
	...
	if(!qObjExists(obj_handle)) return false;
...
bool qBeamHittingPlayer(int beam1_handle, int beam2_handle)
{
	...
	if(!qObjExists(beam1_handle)) return false;
	if(!qObjExists(beam2_handle)) return false;
...
$$END
*/
float qConvertTextureIDToFloat(int texture_id)
{
...
$$END
*/
int qConvertFloatToTextureID(float value)
{
	return ((int)value);
}
...
int	STDCALL GetCOScriptList( int **list, int **id_list )
{
	...
	static int cust_id_list[45] = { 
		ID_CUSTOM_OBJECT_1119,
		ID_CUSTOM_OBJECT_10EC,
		ID_CUSTOM_OBJECT_08F6,
		ID_CUSTOM_OBJECT_08F8,
		ID_CUSTOM_OBJECT_08F7,
		ID_CUSTOM_OBJECT_08FB,
		ID_CUSTOM_OBJECT_08FC,
		ID_CUSTOM_OBJECT_08FE,
		ID_CUSTOM_OBJECT_08FD,
		ID_CUSTOM_OBJECT_08FF,
		ID_CUSTOM_OBJECT_0900,
		ID_CUSTOM_OBJECT_0901,
		ID_CUSTOM_OBJECT_0902,
		ID_CUSTOM_OBJECT_1017,
		ID_CUSTOM_OBJECT_0818,
		ID_CUSTOM_OBJECT_1019,
		ID_CUSTOM_OBJECT_10CF,
		ID_CUSTOM_OBJECT_30B2,
		ID_CUSTOM_OBJECT_10B1,
		ID_CUSTOM_OBJECT_1040,
		ID_CUSTOM_OBJECT_1041,
		ID_CUSTOM_OBJECT_103F,
		ID_CUSTOM_OBJECT_08DE,
		ID_CUSTOM_OBJECT_110E,
		ID_CUSTOM_OBJECT_10CD,
		ID_CUSTOM_OBJECT_08A6,
		ID_CUSTOM_OBJECT_08A5,
		ID_CUSTOM_OBJECT_1112,
		ID_CUSTOM_OBJECT_0913,
		ID_CUSTOM_OBJECT_083D,
		ID_CUSTOM_OBJECT_084A,
		ID_CUSTOM_OBJECT_1048,
		ID_CUSTOM_OBJECT_1111,
		ID_CUSTOM_OBJECT_1067,
		ID_CUSTOM_OBJECT_088C,
		ID_CUSTOM_OBJECT_108B,
		ID_CUSTOM_OBJECT_0883,
		ID_CUSTOM_OBJECT_1884,
		ID_CUSTOM_OBJECT_106F,
		ID_CUSTOM_OBJECT_1071,
		ID_CUSTOM_OBJECT_0894,
		ID_CUSTOM_OBJECT_0893,
		ID_CUSTOM_OBJECT_0806,
		ID_CUSTOM_OBJECT_1842,
		...
		case EVT_INTERVAL:
			{
				...
				{
					if((qBeamHittingPlayer(Object_handles[31], Object_handles[32])==true) || (qBeamHittingPlayer(Object_handles[27], Object_handles[28])==true) || (qBeamHittingPlayer(Object_handles[33], Object_handles[34])==true) || (qBeamHittingPlayer(Object_handles[35], Object_handles[36])==true) || (qBeamHittingPlayer(Object_handles[29], Object_handles[30])==true) || (qBeamHittingPlayer(Object_handles[37], Object_handles[38])==true))
					{
				...
				{
					if((qBeamHittingPlayer(Object_handles[19], Object_handles[20])==true) || (qBeamHittingPlayer(Object_handles[21], Object_handles[22])==true) || (qBeamHittingPlayer(Object_handles[23], Object_handles[24])==true) || (qBeamHittingPlayer(Object_handles[25], Object_handles[26])==true))
					{
						aShowHUDMessage(Message_strings[2]);
						aUserFlagSet(13, 1);
		...
		case EVT_LEVELSTART:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(Object_handles[61], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 2.000000f, 15.000000f, 1, -1);
		...
		case EVT_TIMER:
			{
				...
				if(event_data->id==11)
				{
					if(qUserFlag(14)==false)
					{
						...
						aLightningCreate(Object_handles[31], Object_handles[32], 0.500000f, 4.000000f, 1, qConvertFloatToTextureID(qUserVarValue(6)), 0.000000f, 1, 255, 255, 255, 0);
						aLightningCreate(Object_handles[27], Object_handles[28], 0.500000f, 4.000000f, 1, qConvertFloatToTextureID(qUserVarValue(6)), 0.000000f, 1, 255, 255, 255, 0);
						aLightningCreate(Object_handles[33], Object_handles[34], 0.500000f, 4.000000f, 1, qConvertFloatToTextureID(qUserVarValue(6)), 0.000000f, 1, 255, 255, 255, 0);
						aLightningCreate(Object_handles[35], Object_handles[36], 0.500000f, 4.000000f, 1, qConvertFloatToTextureID(qUserVarValue(6)), 0.000000f, 1, 255, 255, 255, 0);
						aLightningCreate(Object_handles[29], Object_handles[30], 0.500000f, 4.000000f, 1, qConvertFloatToTextureID(qUserVarValue(6)), 0.000000f, 1, 255, 255, 255, 0);
						aLightningCreate(Object_handles[37], Object_handles[38], 0.500000f, 4.000000f, 1, qConvertFloatToTextureID(qUserVarValue(6)), 0.000000f, 1, 255, 255, 255, 0);
					}
				...
				if(event_data->id==12)
				{
					if((qUserFlag(12)==true) && (qUserFlag(13)==false))
					{
						...
						aLightningCreate(Object_handles[19], Object_handles[20], 0.500000f, 4.000000f, 1, qConvertFloatToTextureID(qUserVarValue(6)), 0.000000f, 1, 255, 255, 255, 0);
						aLightningCreate(Object_handles[21], Object_handles[22], 0.500000f, 4.000000f, 1, qConvertFloatToTextureID(qUserVarValue(6)), 0.000000f, 1, 255, 255, 255, 0);
						aLightningCreate(Object_handles[23], Object_handles[24], 0.500000f, 4.000000f, 1, qConvertFloatToTextureID(qUserVarValue(6)), 0.000000f, 1, 255, 255, 255, 0);
						aLightningCreate(Object_handles[25], Object_handles[26], 0.500000f, 4.000000f, 1, qConvertFloatToTextureID(qUserVarValue(6)), 0.000000f, 1, 255, 255, 255, 0);
					}
				...
				if((event_data->id==1) && (qUserFlag(2)==false))
				{
					if(qUserVarValue(0)==8.000000f)
					{
						...
						{
							aLightningCreate(Object_handles[88], Object_handles[89], 1.000000f, 1.000000f, 3, Texture_indexes[7], 0.500000f, 1, 255, 255, 255, 0);
							aLightningCreate(Object_handles[90], Object_handles[91], 1.000000f, 1.000000f, 3, Texture_indexes[7], 0.500000f, 1, 255, 255, 255, 0);
							aLightningCreate(Object_handles[92], Object_handles[93], 1.000000f, 1.000000f, 3, Texture_indexes[7], 0.500000f, 1, 255, 255, 255, 0);
							aLightningCreate(Object_handles[94], Object_handles[95], 1.000000f, 1.000000f, 3, Texture_indexes[7], 0.500000f, 1, 255, 255, 255, 0);
							aLightningCreate(Object_handles[96], Object_handles[97], 1.000000f, 1.000000f, 3, Texture_indexes[7], 0.500000f, 1, 255, 255, 255, 0);
							aLightningCreate(Object_handles[98], Object_handles[99], 1.000000f, 1.000000f, 3, Texture_indexes[7], 0.500000f, 1, 255, 255, 255, 0);
							aUserVarInc(0);
				...
				{
					if(((qObjExists(qObjSavedHandle(0))==0) || (qObjShields(qObjSavedHandle(0))<qObjShieldsOriginal(qObjSavedHandle(0)))) || ((qObjExists(qObjSavedHandle(1))==0) || (qObjShields(qObjSavedHandle(1))<qObjShieldsOriginal(qObjSavedHandle(1)))) || ((qObjExists(qObjSavedHandle(3))==0) || (qObjShields(qObjSavedHandle(3))<qObjShieldsOriginal(qObjSavedHandle(3)))) || ((qObjExists(qObjSavedHandle(4))==0) || (qObjShields(qObjSavedHandle(4))<qObjShieldsOriginal(qObjSavedHandle(4)))))
					{
				...
				{
					if((qObjExists(qObjSavedHandle(6))==false) || (qObjShields(qObjSavedHandle(6))<qObjShieldsOriginal(qObjSavedHandle(6))))
					{
				...
				if(event_data->id==14)
				{
					...
					if(ScriptActionCtr_063==1)
					{
						...
						aTurnOnSpew(Object_handles[102], -1, 0, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.100000f, 3.500000f, 2.000000f, 17.000000f, 0, -1);
						aSetLevelTimer(1.500000f, 14);
					}
				...
				if(event_data->id==19)
				{
					if(ScriptActionCtr_089==0)
					{
						...
						aTurnOnSpew(Object_handles[105], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.200000f, -1.000000f, 6.000000f, 35.000000f, 1, -1);
						aTurnOnSpew(Object_handles[106], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.200000f, -1.000000f, 6.000000f, 35.000000f, 1, -1);
						aTurnOnSpew(Object_handles[107], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.200000f, -1.000000f, 6.000000f, 35.000000f, 1, -1);
						aTurnOnSpew(Object_handles[108], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.200000f, -1.000000f, 6.000000f, 35.000000f, 1, -1);
						...
						aLightningCreate(Object_handles[39], Object_handles[40], 1000000.000000f, 12.000000f, 3, Texture_indexes[11], 0.300000f, 1, 255, 255, 255, 0);
					...
					if(ScriptActionCtr_089==1)
					{
						...
						aLightningCreate(Object_handles[41], Object_handles[42], 1000000.000000f, 12.000000f, 3, Texture_indexes[11], 0.300000f, 1, 255, 255, 255, 0);
					...
					if(ScriptActionCtr_089==2)
					{
						...
						aLightningCreate(Object_handles[43], Object_handles[44], 1000000.000000f, 12.000000f, 3, Texture_indexes[11], 0.300000f, 1, 255, 255, 255, 0);
				...
				if(event_data->id==20)
				{
					if((qUserFlag(24)==false) || (qUserFlag(25)==true))
					{
						...
						aLightningCreate(Object_handles[122], qObjSavedHandle(7), 0.500000f, 3.000000f, 3, Texture_indexes[11], 0.500000f, 1, 255, 255, 255, 0);
						aLightningCreate(Object_handles[123], qObjSavedHandle(7), 0.500000f, 3.000000f, 3, Texture_indexes[11], 0.500000f, 1, 255, 255, 255, 0);
						aLightningCreate(Object_handles[124], qObjSavedHandle(7), 0.500000f, 3.000000f, 3, Texture_indexes[11], 0.500000f, 1, 255, 255, 255, 0);
					}
					aSetLevelTimer(0.500000f, 20);
		...
		case EVT_DESTROY:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[83], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 2.000000f, 15.000000f, 1, -1);
		...
		case EVT_DESTROY:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[85], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 2.000000f, 15.000000f, 1, -1);
		...
		case EVT_DESTROY:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[87], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 2.000000f, 15.000000f, 1, -1);
					if(qUserFlag(15)==false)
					{
						aRoomSetFog(Room_indexes[3], 0.500000f, 0.500000f, 0.500000f, 1000.000000f);
						aRoomFogSetState(1, Room_indexes[3]);
		...
		case EVT_COLLIDE:
			{
				...
				if((qObjIsPlayer(event_data->it_handle)==true) && (qUserFlag(0)==false) && (qUserFlag(1)==false) && (qUserFlag(2)==false))
				{
					aSoundPlaySteaming("VoxMerc02FCV1.osf", 1.000000f);
		...
		case EVT_AIN_GOALCOMPLETE:
			{
				...
				{
					aTurnOnSpew(Object_handles[65], 0, 7, 0.000000f, 0.000000f, 65536, 0, 0.800000f, 0.100000f, -1.000000f, 3.000000f, 20.000000f, 0, 0);
					aTurnOnSpew(Object_handles[65], 1, 7, 0.000000f, 0.000000f, 65536, 0, 0.800000f, 0.100000f, -1.000000f, 3.000000f, 20.000000f, 0, 1);
					aTurnOnSpew(Object_handles[65], 2, 7, 0.000000f, 0.000000f, 65536, 0, 0.800000f, 0.100000f, -1.000000f, 3.000000f, 20.000000f, 0, 2);
					aTurnOnSpew(Object_handles[65], 3, 7, 0.000000f, 0.000000f, 65536, 0, 0.800000f, 0.100000f, -1.000000f, 3.000000f, 20.000000f, 0, 3);
		...
		case EVT_COLLIDE:
			{
				...
				{
					if((qGoalEnabled(Goal_indexes[6])==true) && (qGoalCompleted(Goal_indexes[6])==false) && (qGoalCompleted(Goal_indexes[7])==false))
					{
