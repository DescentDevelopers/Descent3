...
#define N_REGIONS 2
const char *RegionList[N_REGIONS] = {
	"LeftLabR",
	"RightLabR"
};
...
$$ACTION
Custom
Change fog in region [e:LevelRegion] to color = [f:Red=0.5],[f:Green=0.5],[f:Blue=0.5], depth = [f:Depth=200.0] over [f:Time=20.0] seconds
cChangeFogRegion
Change region fog over time
	Changes the fog of a predefined region to a color over a time period
...
{
	if (breaking_glass_index >= 64) breaking_glass_index = 0;
...
int	STDCALL GetCOScriptList( int **list, int **id_list )
{
	...
	static int cust_id_list[35] = { 
		ID_CUSTOM_OBJECT_11C4,
		ID_CUSTOM_OBJECT_1088,
		ID_CUSTOM_OBJECT_09C6,
		ID_CUSTOM_OBJECT_11C5,
		ID_CUSTOM_OBJECT_09C7,
		ID_CUSTOM_OBJECT_182E,
		ID_CUSTOM_OBJECT_0A05,
		ID_CUSTOM_OBJECT_0A04,
		ID_CUSTOM_OBJECT_0A03,
		ID_CUSTOM_OBJECT_1A02,
		ID_CUSTOM_OBJECT_1033,
		ID_CUSTOM_OBJECT_1200,
		ID_CUSTOM_OBJECT_1036,
		ID_CUSTOM_OBJECT_1035,
		ID_CUSTOM_OBJECT_3032,
		ID_CUSTOM_OBJECT_1830,
		ID_CUSTOM_OBJECT_28A2,
		ID_CUSTOM_OBJECT_0A06,
		ID_CUSTOM_OBJECT_2885,
		ID_CUSTOM_OBJECT_107E,
		ID_CUSTOM_OBJECT_1185,
		ID_CUSTOM_OBJECT_21B2,
		ID_CUSTOM_OBJECT_09DE,
		ID_CUSTOM_OBJECT_09DD,
		ID_CUSTOM_OBJECT_09DC,
		ID_CUSTOM_OBJECT_21DA,
		ID_CUSTOM_OBJECT_0899,
		ID_CUSTOM_OBJECT_089A,
		ID_CUSTOM_OBJECT_089B,
		ID_CUSTOM_OBJECT_1098,
		ID_CUSTOM_OBJECT_09A1,
		ID_CUSTOM_OBJECT_19A0,
		ID_CUSTOM_OBJECT_09C9,
		ID_CUSTOM_OBJECT_1007,
		ID_CUSTOM_OBJECT_1016
	};
		...
		case EVT_LEVELSTART:
			{
				...
				if(1)
				{
					...
					aLightningCreate(Object_handles[36], Object_handles[38], 99999.000000f, 2.000000f, 1, Texture_indexes[0], 0.300000f, 3, 180, 180, 255, 0);
					aLightningCreate(Object_handles[35], Object_handles[39], 99999.000000f, 2.000000f, 1, Texture_indexes[0], 0.300000f, 3, 180, 180, 255, 0);
					aLightningCreate(Object_handles[34], Object_handles[40], 99999.000000f, 2.000000f, 1, Texture_indexes[0], 0.300000f, 3, 180, 180, 255, 0);
					aLightningCreate(Object_handles[33], Object_handles[41], 99999.000000f, 2.000000f, 1, Texture_indexes[0], 0.300000f, 3, 180, 180, 255, 0);
				...
				if(1)
				{
					aLightningCreate(Object_handles[76], Object_handles[77], 99999.000000f, 5.000000f, 1, Texture_indexes[1], 0.400000f, 2, 255, 150, 255, 0);
					aLightningCreate(Object_handles[76], Object_handles[77], 99999.000000f, 3.500000f, 1, Texture_indexes[3], 0.800000f, 2, 100, 100, 255, 0);
					aLightningCreate(Object_handles[78], Object_handles[79], 99999.000000f, 5.000000f, 1, Texture_indexes[1], 0.400000f, 2, 255, 150, 255, 0);
					aLightningCreate(Object_handles[78], Object_handles[79], 99999.000000f, 3.500000f, 1, Texture_indexes[3], 0.800000f, 2, 100, 100, 255, 0);
				...
				if(1)
				{
					...
					aLightningCreate(Object_handles[143], Object_handles[7], 99999.000000f, 3.000000f, 1, Texture_indexes[1], 0.500000f, 3, 200, 100, 255, 0);
					aLightningCreate(Object_handles[144], Object_handles[6], 99999.000000f, 3.000000f, 1, Texture_indexes[1], 0.500000f, 3, 200, 100, 255, 0);
					aLightningCreate(Object_handles[145], Object_handles[5], 99999.000000f, 3.000000f, 1, Texture_indexes[1], 0.500000f, 3, 200, 100, 255, 0);
					aLightningCreate(Object_handles[146], Object_handles[4], 99999.000000f, 3.000000f, 1, Texture_indexes[1], 0.500000f, 3, 200, 100, 255, 0);
					aLightningCreate(Object_handles[147], Object_handles[148], 99999.000000f, 4.500000f, 2, Texture_indexes[1], 0.400000f, 3, 200, 150, 100, 0);
					aLightningCreate(Object_handles[149], Object_handles[150], 99999.000000f, 3.500000f, 2, Texture_indexes[0], 0.500000f, 3, 0, 150, 250, 0);
		...
		case EVT_TIMER:
			{
				...
				if(event_data->id==13)
				{
					aTurnOnSpew(Object_handles[27], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.090000f, 0.700000f, 14.000000f, 100.000000f, 0, -1);
					aTurnOnSpew(Object_handles[28], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.100000f, 0.600000f, 22.000000f, 60.000000f, 0, -1);
		...
		case EVT_PLAYER_MOVIE_END:
			{
				...
				if((ScriptActionCtr_026 < 1) && (1))
				{
					...
					aLightningTurnOn(0.100000f, 0.080000f);
					aTurnOnSpew(Object_handles[169], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.400000f, 0.100000f, 10.000000f, 7.000000f, 50.000000f, 0, -1);
					aTurnOnSpew(Object_handles[170], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.400000f, 0.100000f, 10.000000f, 7.000000f, 50.000000f, 0, -1);
		...
		case EVT_AIN_MOVIE_END:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(Object_handles[19], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.100000f, 10.000000f, 5.000000f, 30.000000f, 0, -1);
					aTurnOnSpew(Object_handles[20], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.100000f, 10.000000f, 5.000000f, 30.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[22], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 20.000000f, 4.000000f, 30.000000f, 0, -1);
					aTurnOnSpew(Object_handles[23], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 20.000000f, 4.000000f, 30.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(event_data->id==3)
				{
					...
					aTurnOnSpew(Object_handles[28], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.400000f, 0.100000f, 0.800000f, 19.000000f, 80.000000f, 0, -1);
		...
		case EVT_COLLIDE:
			{
				...
				if((ScriptActionCtr_033 < 1) && (qObjIsPlayerWeapon(event_data->it_handle)==true))
				{
					...
					aLightningCreate(Object_handles[37], data->me_handle, 99999.000000f, 1.500000f, 2, Texture_indexes[0], 0.500000f, 3, 180, 180, 255, 0);
					aLightningCreate(data->me_handle, Object_handles[37], 99999.000000f, 1.500000f, 2, Texture_indexes[1], 1.000000f, 2, 100, 200, 255, 0);
					aObjSetMovementType(data->me_handle, 1);
		...
		case EVT_COLLIDE:
			{
				...
				if((ScriptActionCtr_032 < 1) && (qObjIsPlayerWeapon(event_data->it_handle)==true))
				{
					...
					aEmitSparks(50.000000f, data->me_handle);
					aEmitSparks(30.000000f, Object_handles[37]);
					aLightningCreate(Object_handles[37], data->me_handle, 99999.000000f, 2.500000f, 2, Texture_indexes[0], 0.500000f, 3, 180, 180, 255, 0);
					aLightningCreate(data->me_handle, Object_handles[37], 99999.000000f, 1.500000f, 2, Texture_indexes[1], 1.000000f, 2, 100, 200, 255, 0);
					aObjSetMovementType(data->me_handle, 1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(Object_handles[44], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.100000f, -1.000000f, 3.000000f, 15.000000f, 0, -1);
					aTurnOnSpew(Object_handles[45], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.100000f, -1.000000f, 3.000000f, 15.000000f, 0, -1);
					aTurnOnSpew(Object_handles[46], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.100000f, -1.000000f, 4.000000f, 30.000000f, 0, -1);
					aTurnOnSpew(Object_handles[47], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.100000f, -1.000000f, 4.000000f, 30.000000f, 0, -1);
					aTurnOnSpew(Object_handles[42], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.100000f, -1.000000f, 4.000000f, 30.000000f, 0, -1);
					...
					aTurnOnSpew(Object_handles[48], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.140000f, 0.600000f, 250.000000f, 50.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					...
					aMiscViewerShake(100.000000f);
					aTurnOnSpew(Object_handles[49], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.140000f, 0.600000f, 300.000000f, 200.000000f, 0, -1);
					aTurnOnSpew(Object_handles[50], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.140000f, 0.600000f, 300.000000f, 200.000000f, 0, -1);
					aTurnOnSpew(Object_handles[51], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.140000f, 0.600000f, 300.000000f, 200.000000f, 0, -1);
					aTurnOnSpew(Object_handles[52], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.140000f, 0.600000f, 300.000000f, 200.000000f, 0, -1);
					aTurnOnSpew(Object_handles[53], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.100000f, 0.140000f, 1.000000f, 300.000000f, 200.000000f, 0, -1);
					aTurnOnSpew(Object_handles[54], -1, 2, 0.000000f, 0.000000f, 65536, 0, 0.900000f, 0.120000f, 0.400000f, 150.000000f, 200.000000f, 0, -1);
					aTurnOnSpew(Object_handles[55], -1, 2, 0.000000f, 0.000000f, 65536, 0, 0.900000f, 0.120000f, 0.400000f, 150.000000f, 200.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.400000f, 0.100000f, 1.700000f, 22.000000f, 60.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.400000f, 0.100000f, 3.200000f, 22.000000f, 60.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.400000f, 0.100000f, 4.700000f, 22.000000f, 60.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.400000f, 0.100000f, 6.200000f, 22.000000f, 60.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					...
					aMiscViewerShake(80.000000f);
					aEmitSparks(50.000000f, data->me_handle);
					aTurnOnSpew(Object_handles[55], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.100000f, 8.000000f, 12.000000f, 80.000000f, 0, -1);
					aTurnOnSpew(Object_handles[54], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.100000f, 8.000000f, 12.000000f, 80.000000f, 0, -1);
					aTurnOnSpew(Object_handles[48], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.100000f, 8.200000f, 14.000000f, 70.000000f, 0, -1);
					aTurnOnSpew(Object_handles[48], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.120000f, 8.200000f, 25.000000f, 50.000000f, 0, -1);
					aLightningCreate(Object_handles[48], Object_handles[60], 8.100000f, 8.000000f, 1, Texture_indexes[2], 0.600000f, 3, 200, 255, 150, 0);
		...
		case EVT_TIMER:
			{
				...
				if(((ScriptActionCtr_006 > 0)==true) && ((ScriptActionCtr_024 > 0)==true) && ((ScriptActionCtr_032 > 0)==true) && ((ScriptActionCtr_033 > 0)==true))
				{
					aSetObjectTimer(Object_handles[60], 1.000000f, -1);
					aMiscViewerShake(40.000000f);
					aEmitSparks(80.000000f, data->me_handle);
					aLightningCreate(Object_handles[48], Object_handles[37], 9.200000f, 2.000000f, 2, Texture_indexes[1], 0.400000f, 3, 100, 200, 255, 0);
					aLightningCreate(Object_handles[60], Object_handles[37], 99999.000000f, 2.000000f, 1, Texture_indexes[1], 0.500000f, 3, 100, 200, 255, 0);
		...
		case EVT_COLLIDE:
			{
				...
				if((ScriptActionCtr_078 < 1) && ((qObjIsPlayerWeapon(event_data->it_handle)==true) && (1)))
				{
					...
					aTurnOnSpew(Object_handles[83], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 3.000000f, 3.000000f, 15.000000f, 0, -1);
					aTurnOnSpew(Object_handles[78], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 3.000000f, 3.000000f, 15.000000f, 0, -1);
				...
				if((qObjIsPlayerWeapon(event_data->it_handle)==true) && (qObjAnimFrame(data->me_handle)==5.000000f) && (qGoalCompleted(Goal_indexes[1])==false))
				{
					if((qUserFlag(0)==false) && (qUserFlag(14)==true))
					{
						aTurnOnSpew(Object_handles[84], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, -1.000000f, 3.000000f, 15.000000f, 0, -1);
						...
						aMiscViewerShake(80.000000f);
						aTurnOnSpew(Object_handles[98], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.100000f, -1.000000f, 5.000000f, 30.000000f, 0, -1);
						aTurnOnSpew(Object_handles[99], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.100000f, -1.000000f, 5.000000f, 30.000000f, 0, -1);
						aSoundPlayObject(Sound_indexes[7], data->me_handle, 1.000000f);
						...
						aLightningCreate(Object_handles[83], Object_handles[78], 99999.000000f, 5.000000f, 1, Texture_indexes[1], 0.400000f, 2, 255, 150, 255, 0);
						aLightningCreate(Object_handles[78], Object_handles[80], 99999.000000f, 3.000000f, 1, Texture_indexes[4], 0.600000f, 3, 255, 255, 255, 0);
						aLightningCreate(Object_handles[83], Object_handles[80], 99999.000000f, 3.000000f, 1, Texture_indexes[4], 0.600000f, 3, 255, 255, 255, 0);
						...
						aTurnOnSpew(Object_handles[100], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, 0);
						aTurnOnSpew(Object_handles[101], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, 1);
						aTurnOnSpew(Object_handles[102], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, 2);
						aTurnOnSpew(Object_handles[103], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, 3);
						aTurnOnSpew(Object_handles[104], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, 4);
						aTurnOnSpew(Object_handles[105], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, 5);
						aTurnOnSpew(Object_handles[106], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, 6);
						aTurnOnSpew(Object_handles[107], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, 7);
						aTurnOnSpew(Object_handles[108], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, 8);
						aTurnOnSpew(Object_handles[109], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, 9);
						aTurnOnSpew(Object_handles[110], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, 10);
		...
		case EVT_COLLIDE:
			{
				...
				if((ScriptActionCtr_013 < 1) && ((qObjIsPlayerWeapon(event_data->it_handle)==true) && (1)))
				{
					...
					aTurnOnSpew(Object_handles[76], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 3.000000f, 3.000000f, 15.000000f, 0, -1);
					aTurnOnSpew(Object_handles[112], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 3.000000f, 3.000000f, 15.000000f, 0, -1);
				...
				if((qObjIsPlayerWeapon(event_data->it_handle)==true) && (qObjAnimFrame(data->me_handle)==5.000000f) && (qGoalCompleted(Goal_indexes[2])==false))
				{
					if((qUserFlag(1)==false) && (qUserFlag(15)==true))
					{
						aTurnOnSpew(Object_handles[113], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, -1.000000f, 3.000000f, 15.000000f, 0, -1);
						...
						aLightningCreate(Object_handles[76], Object_handles[81], 99999.000000f, 3.000000f, 1, Texture_indexes[4], 0.600000f, 3, 255, 255, 255, 0);
						aLightningCreate(Object_handles[112], Object_handles[81], 99999.000000f, 3.000000f, 1, Texture_indexes[4], 0.600000f, 3, 255, 255, 255, 0);
						aLightningCreate(Object_handles[112], Object_handles[76], 99999.000000f, 5.000000f, 1, Texture_indexes[1], 0.400000f, 2, 255, 150, 255, 0);
						aUserFlagSet(1, 1);
						...
						aTurnOnSpew(Object_handles[125], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.100000f, -1.000000f, 5.000000f, 30.000000f, 0, -1);
						aTurnOnSpew(Object_handles[126], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.100000f, -1.000000f, 5.000000f, 30.000000f, 0, -1);
						aTurnOnSpew(Object_handles[127], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, 11);
						aTurnOnSpew(Object_handles[128], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, 12);
						aTurnOnSpew(Object_handles[129], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, 13);
						aTurnOnSpew(Object_handles[130], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, 14);
						aTurnOnSpew(Object_handles[131], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, 15);
						aTurnOnSpew(Object_handles[132], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, 16);
						aTurnOnSpew(Object_handles[133], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, 17);
						aTurnOnSpew(Object_handles[134], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, 18);
						aTurnOnSpew(Object_handles[135], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, 20);
						aTurnOnSpew(Object_handles[136], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, 21);
						aTurnOnSpew(Object_handles[137], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, 22);
						aTurnOnSpew(Object_handles[138], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, 23);
		...
		case EVT_USE:
			{
				...
				if(1)
				{
					if((qObjGetDistance(event_data->it_handle, Object_handles[80])<40.000000f) && (qUserFlag(14)==false) && ((ScriptActionCtr_078 > 0)==true))
					{
						...
						if((qObjGetDistance(event_data->it_handle, Object_handles[81])<40.000000f) && (qUserFlag(15)==false) && ((ScriptActionCtr_013 > 0)==true))
						{
							aShowHUDMessage(Message_strings[8]);
							aUserFlagSet(15, 1);
		...
		case EVT_COLLIDE:
			{
				...
				if((ScriptActionCtr_084 < 1) && (qObjIsPlayerWeapon(event_data->it_handle)==1))
				{
					...
					aTurnOnSpew(Object_handles[3], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.100000f, 2.000000f, 2.500000f, 15.000000f, 0, -1);
					aTurnOnSpew(Object_handles[7], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.100000f, -1.000000f, 2.500000f, 15.000000f, 0, 4);
		...
		case EVT_COLLIDE:
			{
				...
				if((ScriptActionCtr_083 < 1) && (qObjIsPlayerWeapon(event_data->it_handle)==1))
				{
					...
					aTurnOnSpew(Object_handles[2], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.100000f, 2.000000f, 2.500000f, 15.000000f, 0, -1);
					aTurnOnSpew(Object_handles[6], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.100000f, -1.000000f, 2.500000f, 15.000000f, 0, 3);
		...
		case EVT_COLLIDE:
			{
				...
				if((ScriptActionCtr_082 < 1) && (qObjIsPlayerWeapon(event_data->it_handle)==1))
				{
					...
					aTurnOnSpew(Object_handles[1], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.100000f, 2.000000f, 2.500000f, 15.000000f, 0, -1);
					aTurnOnSpew(Object_handles[5], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.100000f, -1.000000f, 2.500000f, 15.000000f, 0, 2);
		...
		case EVT_COLLIDE:
			{
				...
				if((ScriptActionCtr_019 < 1) && (qObjIsPlayerWeapon(event_data->it_handle)==1))
				{
					...
					aTurnOnSpew(Object_handles[0], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.100000f, 2.000000f, 2.500000f, 15.000000f, 0, -1);
					aTurnOnSpew(Object_handles[4], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.100000f, -1.000000f, 2.500000f, 15.000000f, 0, 1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					...
					aLightningCreate(Object_handles[5], Object_handles[141], 99999.000000f, 3.000000f, 2, Texture_indexes[4], 0.500000f, 2, 255, 255, 255, 0);
					aLightningCreate(Object_handles[6], Object_handles[140], 99999.000000f, 3.000000f, 2, Texture_indexes[4], 0.500000f, 2, 255, 255, 255, 0);
					aLightningCreate(Object_handles[4], Object_handles[142], 99999.000000f, 3.000000f, 2, Texture_indexes[4], 0.500000f, 2, 255, 255, 255, 0);
					aLightningCreate(Object_handles[7], Object_handles[139], 99999.000000f, 3.000000f, 2, Texture_indexes[4], 0.500000f, 2, 255, 255, 255, 0);
		...
		case EVT_COLLIDE:
			{
				...
				{
					if(((ScriptActionCtr_084 > 0)==true) && ((ScriptActionCtr_083 > 0)==true) && ((ScriptActionCtr_082 > 0)==true) && ((ScriptActionCtr_019 > 0)==true))
					{
						...
						aTurnOnSpew(Object_handles[150], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.100000f, -1.000000f, 2.500000f, 15.000000f, 0, -1);
						aTurnOnSpew(Object_handles[147], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.100000f, -1.000000f, 2.500000f, 15.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if((ScriptActionCtr_025 < 1) && (1))
				{
					...
					aTurnOnSpew(Object_handles[165], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 3.000000f, 3.000000f, 20.000000f, 0, -1);
					aTurnOnSpew(Object_handles[166], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.120000f, 10.000000f, 4.000000f, 30.000000f, 0, -1);
					aTurnOnSpew(Object_handles[167], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.120000f, 10.000000f, 4.000000f, 30.000000f, 0, -1);
					aTurnOnSpew(Object_handles[168], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 3.000000f, 3.000000f, 20.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[166], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 10.000000f, 5.000000f, 30.000000f, 0, -1);
					aTurnOnSpew(Object_handles[167], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 10.000000f, 5.000000f, 30.000000f, 0, -1);
		...
		case EVT_COLLIDE:
			{
				...
				{
					aTurnOnSpew(Object_handles[29], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.120000f, 0.800000f, 32.000000f, 70.000000f, 0, -1);
					aTurnOnSpew(Object_handles[29], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.400000f, 0.100000f, 0.500000f, 20.000000f, 110.000000f, 0, -1);
					aTurnOnSpew(Object_handles[30], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.400000f, 0.100000f, 0.700000f, 22.000000f, 100.000000f, 0, -1);
					aTurnOnSpew(Object_handles[31], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.400000f, 0.100000f, 0.700000f, 22.000000f, 100.000000f, 0, -1);
		...
		case EVT_COLLIDE:
			{
				...
				if((ScriptActionCtr_038 < 1) && ((qObjIsPlayer(event_data->it_handle)==1) && ((ScriptActionCtr_085 > 0)==true)))
				{
					aCancelTimer(16);
