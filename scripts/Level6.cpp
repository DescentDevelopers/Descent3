...
void aPriestKeyRoomChange(void)
{
	...
	GoodRoom = PriestKeyRoomMap[PriestCorrectPath[Var_PriestPlayerCurrNode+1].y][PriestCorrectPath[Var_PriestPlayerCurrNode+1].x];
...
int	STDCALL GetCOScriptList( int **list, int **id_list )
{
	...
	static int cust_id_list[20] = { 
		ID_CUSTOM_OBJECT_208F,
		ID_CUSTOM_OBJECT_20BE,
		ID_CUSTOM_OBJECT_206F,
		ID_CUSTOM_OBJECT_10A5,
		ID_CUSTOM_OBJECT_081D,
		ID_CUSTOM_OBJECT_081E,
		ID_CUSTOM_OBJECT_08F7,
		ID_CUSTOM_OBJECT_081C,
		ID_CUSTOM_OBJECT_081B,
		ID_CUSTOM_OBJECT_10C7,
		ID_CUSTOM_OBJECT_18B9,
		ID_CUSTOM_OBJECT_2051,
		ID_CUSTOM_OBJECT_1826,
		ID_CUSTOM_OBJECT_08FD,
		ID_CUSTOM_OBJECT_180A,
		ID_CUSTOM_OBJECT_216E,
		ID_CUSTOM_OBJECT_3167,
		ID_CUSTOM_OBJECT_1964,
		ID_CUSTOM_OBJECT_316A,
		...
		case EVT_INTERVAL:
			{
				...
				if((ScriptActionCtr_009 < 1) && ((qObjRoom(Object_handles[10])==Room_indexes[2]) && (qObjRoom(Object_handles[7])==Room_indexes[3])))
				{
		...
		case EVT_LEVELSTART:
			{
				...
				{
					aTurnOnSpew(Object_handles[34], -1, 8, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, 1000000000.000000f, 4.000000f, 20.000000f, 1, -1);
					aTurnOnSpew(Object_handles[35], -1, 8, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, 1000000000.000000f, 4.000000f, 20.000000f, 1, -1);
					aTurnOnSpew(Object_handles[36], -1, 8, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, 1000000000.000000f, 4.000000f, 20.000000f, 1, -1);
					aTurnOnSpew(Object_handles[37], -1, 8, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, 1000000000.000000f, 4.000000f, 20.000000f, 1, -1);
		...
		case EVT_COLLIDE:
			{
				...
				if((qObjIsPlayer(event_data->it_handle)==1) && ((qUserVarValue(0)==1.000000f) && (qUserVarValue(1)!=1.000000f)))
				{
		...
		case EVT_USE:
			{
				...
				if(1)
				{
					if((qObjRoom(event_data->it_handle)==Room_indexes[2]) || (qObjRoom(event_data->it_handle)==Room_indexes[3]))
					{
		...
		case EVT_COLLIDE:
			{
				...
				if(0==true)
				{
					aLightningCreate(Object_handles[14], Object_handles[15], 10.000000f, 4.000000f, 1, Texture_indexes[0], 0.300000f, 1, 255, 255, 255, 0);
		...
		case EVT_DESTROY:
			{
				...
				if((ScriptActionCtr_016 < 1) && (1))
				{
					...
					if(qUserVarValueInt(4)==2)
					{
						...
						aSoundPlay2D(Sound_indexes[2], 1.000000f);
						aTurnOnSpew(Object_handles[18], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, 40.000000f, 4.000000f, 20.000000f, 1, -1);
						aTurnOnSpew(Object_handles[18], 1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, 40.000000f, 4.000000f, 20.000000f, 1, -1);
					}
		...
		case EVT_DESTROY:
			{
				...
				if((ScriptActionCtr_015 < 1) && (1))
				{
					...
					if(qUserVarValueInt(4)==2)
					{
						aObjGravityEnable(1, Object_handles[18]);
						aSoundPlay2D(Sound_indexes[2], 1.000000f);
						aTurnOnSpew(Object_handles[18], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, 30.000000f, 4.000000f, 20.000000f, 1, -1);
						aTurnOnSpew(Object_handles[18], 1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, 30.000000f, 4.000000f, 20.000000f, 1, -1);
					}
		...
		case EVT_INTERVAL:
			{
				...
				if((ScriptActionCtr_066 < 1) && ((qObjAnimFrame(Object_handles[24])!=210.000000f) && (qUserVarValueInt(13)==1)))
				{
