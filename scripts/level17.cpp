...
static const char *Path_names[NUM_PATH_NAMES] = {"IntroCam", "IntroShip"};
...
static const char *const Message_names[NUM_MESSAGE_NAMES] = {
    "FlameDeactivated", "RedKeyFF",         "BlueKeyFF", "NameRedKey", "NameBlueKey",
    "ReactorFF",        "ReactorDestroyed", "RedDoor",   "BlueDoor",   "IntroCam"};
