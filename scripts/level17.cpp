		...
		case EVT_DESTROY:
			{
				...
				if((ScriptActionCtr_074 < 1) && (1))
				{
					...
					aTurnOnSpew(Object_handles[69], -1, 8, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 25.000000f, 4.000000f, 40.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(Object_handles[71], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
					aTurnOnSpew(Object_handles[74], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
					aTurnOnSpew(Object_handles[73], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
					aTurnOnSpew(Object_handles[72], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(Object_handles[70], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
