...
int	STDCALL GetCOScriptList( int **list, int **id_list )
{
	...
	static int cust_id_list[38] = { 
		ID_CUSTOM_OBJECT_082D,
		ID_CUSTOM_OBJECT_082E,
		ID_CUSTOM_OBJECT_082F,
		ID_CUSTOM_OBJECT_0830,
		ID_CUSTOM_OBJECT_0831,
		ID_CUSTOM_OBJECT_2112,
		ID_CUSTOM_OBJECT_11F2,
		ID_CUSTOM_OBJECT_11F4,
		ID_CUSTOM_OBJECT_11F6,
		ID_CUSTOM_OBJECT_19F7,
		ID_CUSTOM_OBJECT_11FB,
		ID_CUSTOM_OBJECT_1211,
		ID_CUSTOM_OBJECT_0885,
		ID_CUSTOM_OBJECT_080D,
		ID_CUSTOM_OBJECT_09EC,
		ID_CUSTOM_OBJECT_11EB,
		ID_CUSTOM_OBJECT_19E9,
		ID_CUSTOM_OBJECT_19E8,
		ID_CUSTOM_OBJECT_19EA,
		ID_CUSTOM_OBJECT_09E7,
		ID_CUSTOM_OBJECT_09E6,
		ID_CUSTOM_OBJECT_11BB,
		ID_CUSTOM_OBJECT_09BC,
		ID_CUSTOM_OBJECT_09BD,
		ID_CUSTOM_OBJECT_09BE,
		ID_CUSTOM_OBJECT_11BF,
		ID_CUSTOM_OBJECT_09C0,
		ID_CUSTOM_OBJECT_11C1,
		ID_CUSTOM_OBJECT_11BA,
		...
		case EVT_INTERVAL:
			{
				...
				if((ScriptActionCtr_038 < 1) && ((qObjCanSeePlayerAdvancedWithStore(3, 360, Object_handles[61], 80.000000f, 1048585)==true) && (qUserFlag(7)==true) && (qObjCanSeeObjAdvanced(Object_handles[61], 60, qObjSavedHandle(3), 1048585)==true)))
				{
				...
				if((ScriptActionCtr_034 < 1) && ((qObjCanSeePlayerAdvancedWithStore(2, 360, Object_handles[60], 80.000000f, 1048585)==true) && (qUserFlag(5)==true) && (qObjCanSeeObjAdvanced(Object_handles[60], 60, qObjSavedHandle(2), 1048585)==true)))
				{
				...
				if((ScriptActionCtr_105 < 1) && ((qObjExists(Object_handles[88])==false) && (qObjExists(Object_handles[89])==false)))
				{
		...
		case EVT_COLLIDE:
			{
				...
				{
					aUserFlagSet(7, 1);
					aTurnOnSpew(Object_handles[37], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 1.000000f, -1.000000f, 8.000000f, 30.000000f, 0, -1);
					aTurnOnSpew(Object_handles[38], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 1.000000f, -1.000000f, 8.000000f, 30.000000f, 0, -1);
					aTurnOnSpew(Object_handles[39], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 1.000000f, -1.000000f, 8.000000f, 30.000000f, 0, -1);
