...
tMyMessage MyMessages[] = 
{
	{"MagicMatCenSwitches",NULL},
	{"MatCenSwitchDOn",NULL},
	{"MatCenSwitchDOff",NULL},
	{"MatCenSwitchGOn",NULL},
	{"MatCenSwitchGOff",NULL},
	{"MatCenSwitchCOn",NULL},
	{"MatCenSwitchCOff",NULL},
	{"MatCenSwitchEOn",NULL},
	{"MatCenSwitchEOff",NULL},
	{"MatCenSwitchBOn",NULL},
	{"MatCenSwitchBOff",NULL},
	{"MatCenSwitchFOn",NULL},
	{"MatCenSwitchFOff",NULL},
	{"MatCenSwitchAOn",NULL},
	{"MatCenSwitchAOff",NULL}
};
...
void SetMatCenToLevel0(int id)
{
	...
	//Make it spew!
	aTurnOnSpew(obj_handle, -1, 7, 0.000000f, 0.000000f, 65536, 0, 2.000000f, 0.100000f, -1.000000f, 4.000000f, 20.000000f, 0, spew_handle);
}
...
void PlayOnAnimation(int obj)
{
	aObjPlayAnim(GetMyObject(obj), 20, 40, 2.000000f, 0);
}

void PlayOffAnimation(int obj)
{
	aObjPlayAnim(GetMyObject(obj), 0, 20, 2.000000f, 0);
}
...
int	STDCALL GetCOScriptList( int **list, int **id_list )
{
	...
	static int cust_id_list[26] = { 
		...
		ID_CUSTOM_OBJECT_399D,
		ID_CUSTOM_OBJECT_210D,
		ID_CUSTOM_OBJECT_210E,
		ID_CUSTOM_OBJECT_190F,
		ID_CUSTOM_OBJECT_2801,
		ID_CUSTOM_OBJECT_1828,
		ID_CUSTOM_OBJECT_1015,
		ID_CUSTOM_OBJECT_0848,
		ID_CUSTOM_OBJECT_0849,
		ID_CUSTOM_OBJECT_0847,
		ID_CUSTOM_OBJECT_3831,
		ID_CUSTOM_OBJECT_2111,
		...
		case EVT_LEVELSTART:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[34], 0, 8, 0.000000f, 0.000000f, 65536, 0, 14.000000f, 0.300000f, -1.000000f, 200.000000f, 45.000000f, 1, 6);
					aTurnOnSpew(Object_handles[34], 1, 8, 0.000000f, 0.000000f, 65536, 0, 14.000000f, 0.300000f, -1.000000f, 200.000000f, 45.000000f, 1, 6);
					aTurnOnSpew(Object_handles[34], 2, 8, 0.000000f, 0.000000f, 65536, 0, 14.000000f, 0.300000f, -1.000000f, 200.000000f, 45.000000f, 1, 6);
					aTurnOnSpew(Object_handles[34], 3, 8, 0.000000f, 0.000000f, 65536, 0, 14.000000f, 0.300000f, -1.000000f, 200.000000f, 45.000000f, 1, 6);
					aTurnOnSpew(Object_handles[34], 4, 8, 0.000000f, 0.000000f, 65536, 0, 14.000000f, 0.300000f, -1.000000f, 200.000000f, 45.000000f, 1, 6);
					aTurnOnSpew(Object_handles[35], 0, 8, 0.000000f, 0.000000f, 65536, 0, 14.000000f, 0.300000f, -1.000000f, 200.000000f, 45.000000f, 1, 6);
					aTurnOnSpew(Object_handles[35], 1, 8, 0.000000f, 0.000000f, 65536, 0, 14.000000f, 0.300000f, -1.000000f, 200.000000f, 45.000000f, 1, 6);
					aTurnOnSpew(Object_handles[35], 2, 8, 0.000000f, 0.000000f, 65536, 0, 14.000000f, 0.300000f, -1.000000f, 200.000000f, 45.000000f, 1, 6);
					aTurnOnSpew(Object_handles[36], 0, 8, 0.000000f, 0.000000f, 65536, 0, 14.000000f, 0.300000f, -1.000000f, 200.000000f, 45.000000f, 1, 6);
					aTurnOnSpew(Object_handles[36], 1, 8, 0.000000f, 0.000000f, 65536, 0, 14.000000f, 0.300000f, -1.000000f, 200.000000f, 45.000000f, 1, 6);
					aTurnOnSpew(Object_handles[36], 2, 8, 0.000000f, 0.000000f, 65536, 0, 14.000000f, 0.300000f, -1.000000f, 200.000000f, 45.000000f, 1, 6);
					aTurnOnSpew(Object_handles[36], 3, 8, 0.000000f, 0.000000f, 65536, 0, 14.000000f, 0.300000f, -1.000000f, 200.000000f, 45.000000f, 1, 6);
					aTurnOnSpew(Object_handles[36], 4, 8, 0.000000f, 0.000000f, 65536, 0, 14.000000f, 0.300000f, -1.000000f, 200.000000f, 45.000000f, 1, 6);
					aTurnOnSpew(Object_handles[36], 5, 8, 0.000000f, 0.000000f, 65536, 0, 14.000000f, 0.300000f, -1.000000f, 200.000000f, 45.000000f, 1, 6);
		...
		case EVT_COLLIDE:
			{
				...
				if((ScriptActionCtr_003 < 1) && ((qObjIsPlayerWeapon(event_data->it_handle)==true) && (qObjExists(Object_handles[9])==false)))
				{
		...
		case EVT_COLLIDE:
			{
				...
				if((qObjIsPlayerOrPlayerWeapon(event_data->it_handle)==true) && (qDoorOpenable(data->me_handle, event_data->it_handle)==false))
				{
		...
		case EVT_COLLIDE:
			{
				...
				if(qObjIsPlayerWeapon(event_data->it_handle)==true)
				{
					if(qUserFlag(15)==false)
					{
						...
						aTurnOnSpew(Object_handles[30], -1, 8, 0.000000f, 0.000000f, 65536, 0, 0.750000f, 0.100000f, -1.000000f, 2.000000f, 10.000000f, 1, 5);
						aUserFlagSet(15, 1);
