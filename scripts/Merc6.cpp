...
int	STDCALL GetCOScriptList( int **list, int **id_list )
{
	...
	static int cust_id_list[23] = { 
		...
		ID_CUSTOM_OBJECT_403E,
		ID_CUSTOM_OBJECT_783F,
		ID_CUSTOM_OBJECT_1084,
		ID_CUSTOM_OBJECT_0885,
		ID_CUSTOM_OBJECT_1086,
		ID_CUSTOM_OBJECT_2046,
		ID_CUSTOM_OBJECT_08A8,
		ID_CUSTOM_OBJECT_08A9,
		ID_CUSTOM_OBJECT_08B9,
		ID_CUSTOM_OBJECT_5847,
		ID_CUSTOM_OBJECT_1048,
		ID_CUSTOM_OBJECT_104A,
		ID_CUSTOM_OBJECT_108E,
		ID_CUSTOM_OBJECT_1827
	};
		...
		case EVT_TIMER:
			{
				...
				if(event_data->id==12)
				{
					...
					if((qUserFlag(11)==true) && (qUserFlag(12)==false) && (qObjGetDistance(Object_handles[34], Object_handles[39])<100.000000f))
					{
					...
					if((qUserFlag(16)==true) && (qUserFlag(13)==false) && (qObjGetDistance(Object_handles[34], Object_handles[40])<100.000000f))
					{
						aShowHUDMessage(Message_strings[19]);
					...
					if((qUserFlag(13)==true) && (qUserFlag(14)==false) && (qObjGetDistance(Object_handles[34], Object_handles[41])<100.000000f))
					{
				...
				if(event_data->id==7)
				{
					...
					{
						aLightningCreate(Object_handles[50], Object_handles[51], 1000000.000000f, 2.000000f, 2, Texture_indexes[3], 0.400000f, 1, 255, 255, 255, 0);
						aSetLevelTimer(3.000000f, 7);
					}
					if(ScriptActionCtr_064==1)
					{
						aLightningCreate(Object_handles[50], Object_handles[52], 1000000.000000f, 4.000000f, 1, Texture_indexes[4], 0.400000f, 1, 255, 255, 255, 0);
						aLightningCreate(Object_handles[50], Object_handles[53], 1000000.000000f, 4.000000f, 1, Texture_indexes[4], 0.400000f, 1, 255, 255, 255, 0);
						aLightningCreate(Object_handles[50], Object_handles[54], 1000000.000000f, 4.000000f, 1, Texture_indexes[4], 0.400000f, 1, 255, 255, 255, 0);
						aLightningCreate(Object_handles[51], Object_handles[52], 1000000.000000f, 4.000000f, 1, Texture_indexes[4], 0.400000f, 1, 255, 255, 255, 0);
						aLightningCreate(Object_handles[51], Object_handles[53], 1000000.000000f, 4.000000f, 1, Texture_indexes[4], 0.400000f, 1, 255, 255, 255, 0);
						aLightningCreate(Object_handles[51], Object_handles[54], 1000000.000000f, 4.000000f, 1, Texture_indexes[4], 0.400000f, 1, 255, 255, 255, 0);
						aSetLevelTimer(3.000000f, 7);
					}
				...
				if(event_data->id==17)
				{
					...
					{
						aTurnOnSpew(Object_handles[55], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.600000f, 0.100000f, 1000000.000000f, 15.000000f, 50.000000f, 0, -1);
						aSetLevelTimer(2.000000f, 17);
					}
					if(ScriptActionCtr_088==1)
					{
						aTurnOnSpew(Object_handles[56], -1, 2, 0.000000f, 0.000000f, 65536, 0, 0.900000f, 0.100000f, 1000000.000000f, 10.000000f, 90.000000f, 0, -1);
					...
					if(ScriptActionCtr_088==2)
					{
						...
						aTurnOnSpew(Object_handles[50], -1, 2, 0.000000f, 0.000000f, 65536, 0, 0.600000f, 0.100000f, 1000000.000000f, 13.000000f, 50.000000f, 0, -1);
						aTurnOnSpew(Object_handles[57], -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.500000f, 0.200000f, 1000000.000000f, 3.000000f, 10.000000f, 0, -1);
				...
				if(event_data->id==15)
				{
					...
					{
						aTurnOnSpew(Object_handles[27], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.200000f, 2.000000f, 33.000000f, 200.000000f, 1, -1);
					}
		...
		case EVT_COLLIDE:
			{
				...
				if((ScriptActionCtr_083 < 1) && ((qUserFlag(17)==false) && (qObjIsPlayerOrPlayerWeapon(event_data->it_handle)==true)))
				{
					aUserFlagSet(17, 1);
		...
		case EVT_COLLIDE:
			{
				...
				if((qObjIsPlayerOrPlayerWeapon(event_data->it_handle)==true) && (qUserFlag(6)==false) && (qUserFlag(7)==false) && ((qObjAnimFrame(data->me_handle)==0.000000f) || (qObjAnimFrame(data->me_handle)==20.000000f)))
				{
					if(qRoomHasPlayer(Room_indexes[4])==1)
					{
						if(qUserFlag(3)==true)
