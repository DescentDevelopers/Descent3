...
int	STDCALL GetCOScriptList( int **list, int **id_list )
{
	...
	static int cust_id_list[75] = { 
		ID_CUSTOM_OBJECT_0821,
		ID_CUSTOM_OBJECT_0820,
		ID_CUSTOM_OBJECT_181E,
		ID_CUSTOM_OBJECT_081F,
		ID_CUSTOM_OBJECT_0814,
		ID_CUSTOM_OBJECT_0815,
		ID_CUSTOM_OBJECT_0816,
		ID_CUSTOM_OBJECT_0818,
		ID_CUSTOM_OBJECT_0819,
		ID_CUSTOM_OBJECT_0817,
		ID_CUSTOM_OBJECT_1024,
		ID_CUSTOM_OBJECT_0826,
		ID_CUSTOM_OBJECT_0828,
		ID_CUSTOM_OBJECT_0827,
		ID_CUSTOM_OBJECT_086A,
		ID_CUSTOM_OBJECT_086B,
		ID_CUSTOM_OBJECT_0829,
		ID_CUSTOM_OBJECT_08C4,
		ID_CUSTOM_OBJECT_10CE,
		ID_CUSTOM_OBJECT_0809,
		ID_CUSTOM_OBJECT_0808,
		ID_CUSTOM_OBJECT_1007,
		ID_CUSTOM_OBJECT_1006,
		ID_CUSTOM_OBJECT_0805,
		ID_CUSTOM_OBJECT_1004,
		ID_CUSTOM_OBJECT_1003,
		ID_CUSTOM_OBJECT_100E,
		ID_CUSTOM_OBJECT_0845,
		ID_CUSTOM_OBJECT_0844,
		ID_CUSTOM_OBJECT_0843,
		ID_CUSTOM_OBJECT_0842,
		ID_CUSTOM_OBJECT_0841,
		ID_CUSTOM_OBJECT_0840,
		ID_CUSTOM_OBJECT_083F,
		ID_CUSTOM_OBJECT_083E,
		ID_CUSTOM_OBJECT_083D,
		ID_CUSTOM_OBJECT_083C,
		ID_CUSTOM_OBJECT_083B,
		ID_CUSTOM_OBJECT_083A,
		ID_CUSTOM_OBJECT_0851,
		ID_CUSTOM_OBJECT_0850,
		ID_CUSTOM_OBJECT_084F,
		ID_CUSTOM_OBJECT_084E,
		...
		ID_CUSTOM_OBJECT_085D,
		ID_CUSTOM_OBJECT_085C,
		ID_CUSTOM_OBJECT_085B,
		ID_CUSTOM_OBJECT_085A,
		ID_CUSTOM_OBJECT_0859,
		ID_CUSTOM_OBJECT_0858,
		ID_CUSTOM_OBJECT_0857,
		ID_CUSTOM_OBJECT_0856,
		ID_CUSTOM_OBJECT_0855,
		ID_CUSTOM_OBJECT_0854,
		ID_CUSTOM_OBJECT_0853,
		ID_CUSTOM_OBJECT_0852,
		ID_CUSTOM_OBJECT_0869,
		ID_CUSTOM_OBJECT_0868,
		ID_CUSTOM_OBJECT_0867,
		ID_CUSTOM_OBJECT_0866,
		ID_CUSTOM_OBJECT_0865,
		ID_CUSTOM_OBJECT_0864,
		ID_CUSTOM_OBJECT_0863,
		ID_CUSTOM_OBJECT_0862,
		ID_CUSTOM_OBJECT_0861,
		ID_CUSTOM_OBJECT_0860,
		ID_CUSTOM_OBJECT_085F,
		ID_CUSTOM_OBJECT_085E
	};
		...
		case EVT_LEVELSTART:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(Object_handles[0], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.100000f, 0.100000f, -1.000000f, 5.000000f, 60.000000f, 0, 3);
					aTurnOnSpew(Object_handles[1], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.100000f, 0.100000f, -1.000000f, 5.000000f, 60.000000f, 0, 2);
					aTurnOnSpew(Object_handles[2], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.100000f, 0.100000f, -1.000000f, 5.000000f, 60.000000f, 0, 1);
					aTurnOnSpew(Object_handles[3], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.100000f, 0.100000f, -1.000000f, 5.000000f, 60.000000f, 0, 0);
		...
		case EVT_TIMER:
			{
				...
				{
					aLightningCreate(Object_handles[69], Object_handles[70], 9999.000000f, 3.000000f, 1, Texture_indexes[0], 0.300000f, 5, 255, 30, 20, 0);
					aLightningCreate(Object_handles[71], Object_handles[70], 9999.000000f, 3.000000f, 1, Texture_indexes[0], 0.300000f, 5, 255, 30, 20, 0);
					aLightningCreate(Object_handles[72], Object_handles[70], 9999.000000f, 3.000000f, 1, Texture_indexes[0], 0.300000f, 5, 255, 30, 20, 0);
					aLightningCreate(Object_handles[73], Object_handles[70], 9999.000000f, 3.000000f, 1, Texture_indexes[0], 0.300000f, 5, 255, 30, 20, 0);
		...
		case EVT_COLLIDE:
			{
				...
				if((qObjIsPlayerWeapon(event_data->it_handle)==true) && (qUserFlag(0)==true))
				{
					...
					if(qObjCanSeeObjAdvanced(qObjSavedHandle(0), 180, Object_handles[98], 1024)==true)
					{
						...
						aLightningCreate(Object_handles[99], qObjSavedHandle(0), 0.600000f, 3.000000f, 1, Texture_indexes[0], -0.700000f, 5, 255, 30, 20, 0);
						aLightningCreate(Object_handles[100], qObjSavedHandle(0), 0.600000f, 3.000000f, 1, Texture_indexes[0], -0.700000f, 5, 255, 30, 20, 0);
						aLightningCreate(Object_handles[101], qObjSavedHandle(0), 0.600000f, 3.000000f, 1, Texture_indexes[0], -0.700000f, 5, 255, 30, 20, 0);
						aLightningCreate(Object_handles[102], qObjSavedHandle(0), 0.600000f, 3.000000f, 1, Texture_indexes[0], -0.700000f, 5, 255, 30, 20, 0);
						...
						aLightningCreate(Object_handles[103], Object_handles[98], 0.600000f, 6.000000f, 1, Texture_indexes[0], 0.700000f, 5, 255, 30, 20, 0);
						aLightningCreate(Object_handles[99], Object_handles[103], 0.600000f, 4.000000f, 1, Texture_indexes[0], 0.700000f, 5, 255, 30, 20, 0);
						aLightningCreate(Object_handles[100], Object_handles[103], 0.600000f, 4.000000f, 1, Texture_indexes[0], 0.400000f, 5, 255, 30, 20, 0);
						aLightningCreate(Object_handles[101], Object_handles[103], 0.600000f, 4.000000f, 1, Texture_indexes[0], 0.700000f, 5, 255, 30, 20, 0);
						aLightningCreate(Object_handles[102], Object_handles[103], 0.600000f, 4.000000f, 1, Texture_indexes[0], 0.700000f, 5, 255, 30, 20, 0);
					}
		...
		case EVT_DESTROY:
			{
				...
				if((ScriptActionCtr_074 < 1) && (1))
				{
					...
					aTurnOnSpew(Object_handles[74], -1, 8, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 25.000000f, 4.000000f, 40.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(Object_handles[76], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
					aTurnOnSpew(Object_handles[79], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
					aTurnOnSpew(Object_handles[78], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
					aTurnOnSpew(Object_handles[77], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(Object_handles[80], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
					aTurnOnSpew(Object_handles[83], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
					aTurnOnSpew(Object_handles[82], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
					aTurnOnSpew(Object_handles[81], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(Object_handles[84], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
					aTurnOnSpew(Object_handles[85], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
					aTurnOnSpew(Object_handles[86], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
					aTurnOnSpew(Object_handles[87], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(Object_handles[89], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
					aTurnOnSpew(Object_handles[90], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
					aTurnOnSpew(Object_handles[91], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
					aTurnOnSpew(Object_handles[88], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(Object_handles[92], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
					aTurnOnSpew(Object_handles[93], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
					aTurnOnSpew(Object_handles[94], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
					aTurnOnSpew(Object_handles[75], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 9.000000f, 5.000000f, 60.000000f, 0, -1);
