...
$$ACTION
Custom
Play imediate object [o:Object] animation from frame [i:StartFrame] to [i:EndFrame=1], cycle time = [f:CycleTime=1.0], looping = [b:Looping=FALSE]
aObjPlayImmAnim
...
void aABSetScenarioIDs(int obj_handle, int nest_handle, int left_hide_room, int right_hide_room)
{
	...
	if(!qObjExists(obj_handle)) return;
...
{
	if(!qObjExists(alien_handle)) return;
	if(!qObjExists(dest_handle)) return;
	...
	for(i = 0; i < n_scan; i++)
	{
		...
		if(type == OBJ_ROBOT || type == OBJ_PLAYER)
		{
			...
			if(type == OBJ_ROBOT)
			{
				...
				if(id == ROBOT_GUIDEBOT || id == ROBOT_GUIDEBOTRED) continue;
			}
...
void aClearTeleporterArea(int desthandle, int objhandle)
{
	...
	if(!qObjExists(objhandle)) return;
	if(!qObjExists(desthandle)) return;
...
int	STDCALL GetCOScriptList( int **list, int **id_list )
{
	...
	static int cust_id_list[14] = { 
		...
		ID_CUSTOM_OBJECT_0803,
		ID_CUSTOM_OBJECT_3198,
		ID_CUSTOM_OBJECT_099A,
		ID_CUSTOM_OBJECT_099E,
		ID_CUSTOM_OBJECT_09A0,
		ID_CUSTOM_OBJECT_080A,
		ID_CUSTOM_OBJECT_09AC,
		ID_CUSTOM_OBJECT_1138,
		ID_CUSTOM_OBJECT_11B2,
		ID_CUSTOM_OBJECT_31B7,
		ID_CUSTOM_OBJECT_11D1,
		ID_CUSTOM_OBJECT_09D2
	};
		...
		case EVT_INTERVAL:
			{
				...
				if(qUserFlag(18)==false)
				{
					...
					if((qUserFlag(9)==true) && (qUserFlag(10)==true) && (qUserFlag(11)==true) && (qUserFlag(12)==true) && (qUserFlag(13)==true))
					{
		...
		case EVT_TIMER:
			{
				...
				{
					aUserVarInc(0);
					if(((qDoorGetPos(Door_handles[1])==0.000000f) && (qDoorGetPos(Door_handles[0])==0.000000f)) || (qUserVarValue(0)==12.000000f))
					{
						aTurnOnSpew(Object_handles[44], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.200000f, 3.000000f, 2.000000f, 8.000000f, 1, -1);
						aTurnOnSpew(Object_handles[45], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.200000f, 3.000000f, 2.000000f, 8.000000f, 1, -1);
				...
				if(event_data->id==4)
				{
					...
					if(((qDoorGetPos(Door_handles[1])==0.000000f) && (qDoorGetPos(Door_handles[0])==0.000000f)) || (qUserVarValue(0)==12.000000f))
					{
						aTurnOnSpew(Object_handles[41], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.200000f, 3.000000f, 2.000000f, 8.000000f, 1, -1);
						aTurnOnSpew(Object_handles[42], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.200000f, 3.000000f, 2.000000f, 8.000000f, 1, -1);
				...
				if(event_data->id==19)
				{
					...
					{
						aTurnOnSpew(Object_handles[63], -1, 8, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.300000f, -1.000000f, 12.000000f, 60.000000f, 0, 0);
				...
				if(event_data->id==22)
				{
					...
					if(ScriptActionCtr_038==1)
					{
						...
						aTurnOnSpew(Object_handles[63], -1, 1, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 5.000000f, 23.000000f, 170.000000f, 0, -1);
		...
		case EVT_COLLIDE:
			{
				...
				if((ScriptActionCtr_010 < 1) && ((qObjIsPlayer(event_data->it_handle)==true) && ((ScriptActionCtr_060 > 0)==false)))
				{
					...
					aTurnOnSpew(Object_handles[48], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.200000f, -1.000000f, 2.000000f, 8.000000f, 1, -1);
					aTurnOnSpew(Object_handles[49], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.200000f, -1.000000f, 2.000000f, 8.000000f, 1, -1);
		...
		case EVT_COLLIDE:
			{
				...
				if((ScriptActionCtr_060 < 1) && ((qObjIsPlayer(event_data->it_handle)==true) && ((ScriptActionCtr_010 > 0)==false)))
				{
		...
		case EVT_USE:
			{
				...
				if((qObjIsPlayer(event_data->it_handle)==true) && (qUserFlag(8)==false))
				{
					if(qObjGetDistance(event_data->it_handle, Object_handles[59])<40.000000f)
					{
						...
						aUserFlagSet(8, 1);
						aLightningCreate(Object_handles[60], Object_handles[61], 10000.000000f, 2.000000f, 3, Texture_indexes[2], 0.600000f, 1, 255, 255, 255, 0);
							...
							if(qUserFlag(15)==true)
							{
								if(qUserFlag(16)==true)
								{
									...
									if(qAlienBossHealing(Object_handles[37])==true)
									{
										...
										aObjPlayAnim(data->me_handle, 0, 1, 2.000000f, 0);
										aSoundPlayObject(Sound_indexes[11], data->me_handle, 1.000000f);
										aTurnOnSpew(Object_handles[63], -1, 1, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 3.000000f, 23.000000f, 145.000000f, 0, -1);
										aSoundPlayObject(Sound_indexes[12], Object_handles[63], 1.000000f);
								...
								aUserFlagSet(17, 1);
								aTurnOnSpew(Object_handles[63], -1, 8, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 3.000000f, 16.000000f, 130.000000f, 0, -1);
		...
		case EVT_DESTROY:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(Object_handles[73], -1, 7, 0.000000f, 0.000000f, 65536, 0, 3.000000f, 0.400000f, -1.000000f, 6.000000f, 10.000000f, 1, -1);
					aTurnOnSpew(Object_handles[74], -1, 7, 0.000000f, 0.000000f, 65536, 0, 4.000000f, 0.400000f, -1.000000f, 6.000000f, 10.000000f, 1, -1);
					aTurnOnSpew(Object_handles[75], -1, 7, 0.000000f, 0.000000f, 65536, 0, 6.000000f, 0.400000f, -1.000000f, 6.000000f, 10.000000f, 1, -1);
					aTurnOnSpew(Object_handles[76], -1, 7, 0.000000f, 0.000000f, 65536, 0, 5.000000f, 0.400000f, -1.000000f, 6.000000f, 10.000000f, 1, -1);
					aTurnOnSpew(Object_handles[77], -1, 7, 0.000000f, 0.000000f, 65536, 0, 5.000000f, 0.400000f, -1.000000f, 6.000000f, 10.000000f, 1, -1);
					aTurnOnSpew(Object_handles[78], -1, 7, 0.000000f, 0.000000f, 65536, 0, 6.000000f, 0.400000f, -1.000000f, 6.000000f, 10.000000f, 1, -1);
		...
		case EVT_COLLIDE:
			{
				...
				{
					aUserFlagSet(16, 1);
					aTurnOnSpew(Object_handles[63], -1, 1, 0.000000f, 0.000000f, 65536, 0, 0.700000f, 0.100000f, 0.500000f, 22.000000f, 120.000000f, 0, -1);
					aTurnOnSpew(Object_handles[63], -1, 1, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.150000f, 1.000000f, 16.000000f, 70.000000f, 0, -1);
					aTurnOffSpew(0);
