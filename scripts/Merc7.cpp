...
$$ACTION
Custom
Timer [e:Enable/Disable] forcefield at portal [i:PortalNum] in room [r:Room]; Double-sided = [b:DoublesidedFlag=1], time = [f:Time]
cTimedEnableForcefield
Delayed enabling/disabling of forcefield.
	Delays enabling/disabling of forcefield for a specified time
...
{
	if (wind_fx_index >= 8) wind_fx_index = 0;
...
void cExecTimerEvent(int timerid)
{
	...
	case 0:		// break glass!
		if (index < 8 && index >= 0) {
			aPortalRenderSet(ff_enable_data[index].state,ff_enable_data[index].portal_num,
						ff_enable_data[index].room_number,
	...
	case 1:		// timed wind delay
		if (index < 8 && index >= 0) {
			aRoomSetWind(wind_fx_data[index].room_number,
						wind_fx_data[index].x, wind_fx_data[index].y, wind_fx_data[index].z,
...
char *DC_Valid_Exits[DC_N_VALID_EXITS] = {
	"DCExit-1",
	"DCExit-2",
	"DCExit-3",
	"DCExit-2"
...
char *DC_Valid_Ends[DC_N_VALID_EXITS] = {
	"DCEnd-1",
	"DCEnd-2",
	"DCEnd-3",
	"DCEnd-4"
...
char *DC_Valid_Terms[DC_N_VALID_TERMS] = {
	"DCPath-1",
	"DCPath-2",
	"DCPath-3",
	"DCPath-4",
...
char *DC_Valid_Matcens[DC_N_VALID_MATCENS] = {
	"DCMatcen-1",
	"DCMatcen-2",
	"DCMatcen-3",
	"DCMatcen-4"
	...
	//	alright, check if object is in list.  then check if the goal is there too.
		if (dc_nodes[i].handle == objhandle && dc_nodes[i].goalid == goalid && dc_nodes[i].type != -1) {
			...
			// end and exit and exit room handle indices should match up always
				...
				aAIGoalGotoObject(objhandle, 
						DC_Valid_End_Handles[dc_nodes[i].type_index], 
						GOAL_PRIORITY_LOW, 
						GF_FORCE_AWARENESS | GF_ORIENT_VELOCITY,
						goalid2);
...
int	STDCALL GetCOScriptList( int **list, int **id_list )
{
	...
	static int cust_id_list[67] = { 
		...
		ID_CUSTOM_OBJECT_0884,
		ID_CUSTOM_OBJECT_0903,
		ID_CUSTOM_OBJECT_0902,
		ID_CUSTOM_OBJECT_0901,
		ID_CUSTOM_OBJECT_1025,
		ID_CUSTOM_OBJECT_103B,
		ID_CUSTOM_OBJECT_1038,
		ID_CUSTOM_OBJECT_2022,
		ID_CUSTOM_OBJECT_10AF,
		ID_CUSTOM_OBJECT_20AA,
		ID_CUSTOM_OBJECT_1031,
		ID_CUSTOM_OBJECT_0833,
		ID_CUSTOM_OBJECT_0951,
		ID_CUSTOM_OBJECT_0952,
		ID_CUSTOM_OBJECT_0953,
		ID_CUSTOM_OBJECT_0954,
		ID_CUSTOM_OBJECT_095F,
		ID_CUSTOM_OBJECT_0960,
		ID_CUSTOM_OBJECT_0961,
		ID_CUSTOM_OBJECT_0962,
		ID_CUSTOM_OBJECT_0869,
		ID_CUSTOM_OBJECT_0963,
		ID_CUSTOM_OBJECT_0964,
		ID_CUSTOM_OBJECT_0965,
		ID_CUSTOM_OBJECT_0966,
		ID_CUSTOM_OBJECT_0995,
		ID_CUSTOM_OBJECT_0994,
		ID_CUSTOM_OBJECT_0993,
		ID_CUSTOM_OBJECT_0992,
		ID_CUSTOM_OBJECT_1191,
		ID_CUSTOM_OBJECT_083D,
		ID_CUSTOM_OBJECT_103C,
		ID_CUSTOM_OBJECT_103E,
		ID_CUSTOM_OBJECT_0841,
		ID_CUSTOM_OBJECT_097A,
		ID_CUSTOM_OBJECT_0997,
		ID_CUSTOM_OBJECT_0996,
		ID_CUSTOM_OBJECT_0805,
		ID_CUSTOM_OBJECT_0804,
		ID_CUSTOM_OBJECT_0998,
		ID_CUSTOM_OBJECT_087E,
		ID_CUSTOM_OBJECT_1834,
		ID_CUSTOM_OBJECT_1877,
		ID_CUSTOM_OBJECT_1078,
		ID_CUSTOM_OBJECT_1070,
		ID_CUSTOM_OBJECT_2075,
		ID_CUSTOM_OBJECT_2076,
		ID_CUSTOM_OBJECT_2863,
		ID_CUSTOM_OBJECT_207A,
		ID_CUSTOM_OBJECT_206D,
		ID_CUSTOM_OBJECT_1079,
		ID_CUSTOM_OBJECT_09BF,
		ID_CUSTOM_OBJECT_09BE,
		ID_CUSTOM_OBJECT_09BD,
		ID_CUSTOM_OBJECT_09BC,
		ID_CUSTOM_OBJECT_1071,
		ID_CUSTOM_OBJECT_09CA,
		ID_CUSTOM_OBJECT_09C9,
		ID_CUSTOM_OBJECT_09C8,
		ID_CUSTOM_OBJECT_09C7,
		ID_CUSTOM_OBJECT_09C6,
		ID_CUSTOM_OBJECT_09C5,
		ID_CUSTOM_OBJECT_09C4,
		ID_CUSTOM_OBJECT_09C3,
		ID_CUSTOM_OBJECT_09C2,
		ID_CUSTOM_OBJECT_286E
	};
		...
		case EVT_LEVELSTART:
			{
				...
				if(1==true)
				{
					aTurnOnSpew(Object_handles[0], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.120000f, -1.000000f, 5.000000f, 30.000000f, 0, -1);
					aTurnOnSpew(Object_handles[1], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.120000f, -1.000000f, 5.000000f, 30.000000f, 0, -1);
					aTurnOnSpew(Object_handles[2], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.120000f, -1.000000f, 5.000000f, 30.000000f, 0, -1);
					aTurnOnSpew(Object_handles[3], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.120000f, -1.000000f, 5.000000f, 30.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				{
					aLightningCreate(Object_handles[110], Object_handles[111], 99999.000000f, 2.000000f, 1, Texture_indexes[1], 0.400000f, 3, 200, 255, 150, 0);
					aLightningCreate(Object_handles[112], Object_handles[113], 99999.000000f, 2.000000f, 1, Texture_indexes[1], 0.400000f, 3, 200, 255, 150, 0);
					aLightningCreate(Object_handles[114], Object_handles[115], 99999.000000f, 2.000000f, 1, Texture_indexes[1], 0.400000f, 3, 200, 255, 150, 0);
		...
		case EVT_AIN_GOALCOMPLETE:
			{
				...
				if(event_data->goal_uid==0)
				{
					...
					aTurnOnSpew(Object_handles[53], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 8.000000f, 3.000000f, 20.000000f, 0, -1);
					aTurnOnSpew(Object_handles[54], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 8.000000f, 3.000000f, 20.000000f, 0, -1);
				...
				if(event_data->goal_uid==2)
				{
					...
					aTurnOnSpew(Object_handles[57], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 8.000000f, 3.000000f, 20.000000f, 0, -1);
					aTurnOnSpew(Object_handles[58], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 8.000000f, 3.000000f, 20.000000f, 0, -1);
				...
				if(event_data->goal_uid==5)
				{
					...
					aTurnOnSpew(Object_handles[62], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 8.000000f, 3.000000f, 20.000000f, 0, -1);
					aTurnOnSpew(Object_handles[63], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 8.000000f, 3.000000f, 20.000000f, 0, -1);
		...
		case EVT_MATCEN_CREATE:
			{
				...
				if((event_data->id==Matcen_indexes[6]) || (event_data->id==Matcen_indexes[7]) || (event_data->id==Matcen_indexes[8]) || (event_data->id==Matcen_indexes[9]))
				{
		...
		case EVT_AIN_MOVIE_END:
			{
				...
				{
					aTurnOnSpew(Object_handles[6], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.100000f, 0.100000f, -1.000000f, 3.000000f, 25.000000f, 0, -1);
					aTurnOnSpew(Object_handles[7], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.100000f, 0.100000f, -1.000000f, 3.000000f, 25.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[56], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 8.000000f, 3.000000f, 20.000000f, 0, -1);
					aTurnOnSpew(Object_handles[55], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 8.000000f, 3.000000f, 20.000000f, 0, -1);
					aMiscShakeArea(data->me_handle, 30.000000f, 300.000000f);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[59], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 8.000000f, 3.000000f, 20.000000f, 0, -1);
					aTurnOnSpew(Object_handles[60], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 8.000000f, 3.000000f, 20.000000f, 0, -1);
					aMiscShakeArea(data->me_handle, 30.000000f, 300.000000f);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[64], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 8.000000f, 3.000000f, 20.000000f, 0, -1);
					aTurnOnSpew(Object_handles[65], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 8.000000f, 3.000000f, 20.000000f, 0, -1);
					aMiscShakeArea(data->me_handle, 30.000000f, 300.000000f);
		...
		case EVT_TIMER:
			{
				...
				// Script 031: FIRE!
				if(((ScriptActionCtr_027 > 0)==true) && ((ScriptActionCtr_026 > 0)==true) && ((ScriptActionCtr_025 > 0)==true) && ((ScriptActionCtr_023 > 0)==true))
				{
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(Object_handles[73], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.120000f, -1.000000f, 8.000000f, 45.000000f, 0, 7);
					aTurnOnSpew(Object_handles[73], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, -1.000000f, 15.000000f, 15.000000f, 0, 11);
		...
		case EVT_TIMER:
			{
				...
				{
					aSetObjectOnFire(data->me_handle, 99999.000000f, 0.000000f);
					aTurnOnSpew(Object_handles[74], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.120000f, -1.000000f, 8.000000f, 45.000000f, 0, 6);
					aTurnOnSpew(Object_handles[74], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, -1.000000f, 15.000000f, 15.000000f, 0, 10);
		...
		case EVT_TIMER:
			{
				...
				{
					aSetObjectOnFire(data->me_handle, 99999.000000f, 0.000000f);
					aTurnOnSpew(Object_handles[75], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.120000f, -1.000000f, 8.000000f, 45.000000f, 0, 5);
					aTurnOnSpew(Object_handles[75], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, -1.000000f, 15.000000f, 15.000000f, 0, 9);
		...
		case EVT_TIMER:
			{
				...
				{
					aSetObjectOnFire(data->me_handle, 99999.000000f, 0.000000f);
					aTurnOnSpew(Object_handles[76], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.120000f, -1.000000f, 8.000000f, 45.000000f, 0, 4);
					aTurnOnSpew(Object_handles[76], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, -1.000000f, 15.000000f, 15.000000f, 0, 8);
		...
		case EVT_DESTROY:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(Object_handles[73], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.120000f, 6.000000f, 5.000000f, 25.000000f, 0, -1);
		...
		case EVT_DESTROY:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(Object_handles[74], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.120000f, 6.000000f, 5.000000f, 25.000000f, 0, -1);
		...
		case EVT_DESTROY:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(Object_handles[75], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.120000f, 6.000000f, 5.000000f, 25.000000f, 0, -1);
		...
		case EVT_DESTROY:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(Object_handles[76], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.120000f, 6.000000f, 5.000000f, 25.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if((ScriptActionCtr_109 < 1) && (1))
				{
					...
					aTurnOnSpew(Object_handles[85], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, -1.000000f, 4.000000f, 25.000000f, 1, -1);
					aTurnOnSpew(Object_handles[86], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, -1.000000f, 4.000000f, 25.000000f, 1, -1);
					aTurnOffSpew(10);
					aTurnOffSpew(11);
		...
		case EVT_AIN_GOALCOMPLETE:
			{
				...
				if((ScriptActionCtr_108 < 1) && (event_data->goal_uid==15))
				{
					...
					aTurnOffSpew(6);
					aTurnOffSpew(7);
					aTurnOnSpew(Object_handles[82], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.120000f, -1.000000f, 6.000000f, 30.000000f, 1, -1);
		...
		case EVT_TIMER:
			{
				...
				{
					aSetObjectTimer(Object_handles[81], 3.000000f, -1);
					aTurnOnSpew(Object_handles[87], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, -1.000000f, 4.000000f, 25.000000f, 1, -1);
					aTurnOnSpew(Object_handles[88], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, -1.000000f, 4.000000f, 25.000000f, 1, -1);
					aTurnOffSpew(9);
					aTurnOffSpew(8);
		...
		case EVT_AIN_GOALCOMPLETE:
			{
				...
				if((ScriptActionCtr_034 < 1) && (event_data->goal_uid==14))
				{
					...
					aTurnOffSpew(4);
					aTurnOffSpew(5);
					aTurnOnSpew(Object_handles[81], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.120000f, -1.000000f, 6.000000f, 30.000000f, 1, -1);
					aSetObjectTimer(data->me_handle, 2.000000f, -1);
		...
		case EVT_COLLIDE:
			{
				...
				if(1)
				{
					if(((event_data->it_handle==Object_handles[66]) || (event_data->it_handle==Object_handles[67])) && ((ScriptActionCtr_031 > 0)==true))
					{
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					...
					aLightningCreate(Object_handles[122], Object_handles[108], 10.000000f, 3.000000f, 1, Texture_indexes[2], 0.400000f, 3, 50, 255, 255, 0);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[124], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.100000f, 10.000000f, 20.000000f, 70.000000f, 0, -1);
					aTurnOnSpew(Object_handles[125], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.100000f, 10.000000f, 20.000000f, 70.000000f, 0, -1);
					aTurnOnSpew(Object_handles[126], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.100000f, 10.000000f, 20.000000f, 70.000000f, 0, -1);
					aTurnOnSpew(Object_handles[127], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.100000f, 10.000000f, 20.000000f, 70.000000f, 0, -1);
					aTurnOnSpew(Object_handles[128], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.130000f, 10.000000f, 20.000000f, 25.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(Object_handles[128], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.100000f, 10.000000f, 10.000000f, 80.000000f, 0, -1);
					aTurnOnSpew(Object_handles[124], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.100000f, 2.000000f, 12.000000f, 70.000000f, 0, -1);
					aTurnOnSpew(Object_handles[127], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.100000f, 2.000000f, 12.000000f, 70.000000f, 0, -1);
					aTurnOnSpew(Object_handles[129], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.130000f, 10.000000f, 20.000000f, 25.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(Object_handles[130], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.130000f, 10.000000f, 20.000000f, 25.000000f, 0, -1);
					aTurnOnSpew(Object_handles[129], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.100000f, 10.000000f, 10.000000f, 80.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					...
					aObjKill(data->me_handle, 1, 2, 2293876, 1.900000f, 1.900000f);
					aTurnOnSpew(Object_handles[130], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.100000f, 10.000000f, 10.000000f, 80.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.100000f, 5.000000f, 8.000000f, 60.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.100000f, 5.000000f, 10.000000f, 90.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.100000f, 5.000000f, 30.000000f, 100.000000f, 0, -1);
					aTurnOnSpew(Object_handles[136], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.130000f, 5.000000f, 50.000000f, 120.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.100000f, 0.100000f, 5.000000f, 8.000000f, 100.000000f, 0, -1);
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.100000f, 5.000000f, 12.000000f, 60.000000f, 0, -1);
		...
		case EVT_AIN_MOVIE_END:
			{
				...
				if((ScriptActionCtr_051 < 1) && (1))
				{
					...
					aTurnOnSpew(Object_handles[137], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.120000f, 4.000000f, 30.000000f, 100.000000f, 0, -1);
					aTurnOnSpew(Object_handles[137], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.120000f, 4.000000f, 15.000000f, 160.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[148], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 5.000000f, 40.000000f, 180.000000f, 0, -1);
					aTurnOnSpew(Object_handles[140], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.140000f, 5.000000f, 60.000000f, 150.000000f, 0, -1);
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.090000f, 3.000000f, 18.000000f, 300.000000f, 0, -1);
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.160000f, 5.000000f, 30.000000f, 160.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[149], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.120000f, 5.000000f, 60.000000f, 150.000000f, 0, -1);
					aTurnOnSpew(Object_handles[150], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.120000f, 5.000000f, 60.000000f, 150.000000f, 0, -1);
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.160000f, 5.000000f, 30.000000f, 160.000000f, 0, -1);
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.090000f, 3.000000f, 18.000000f, 300.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				{
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.090000f, 3.000000f, 18.000000f, 300.000000f, 0, -1);
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.160000f, 6.000000f, 30.000000f, 160.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[139], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.140000f, 4.000000f, 60.000000f, 150.000000f, 0, -1);
					aTurnOnSpew(Object_handles[149], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.120000f, 3.000000f, 40.000000f, 120.000000f, 0, -1);
					aTurnOnSpew(Object_handles[150], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.120000f, 3.000000f, 40.000000f, 120.000000f, 0, -1);
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.090000f, 3.000000f, 18.000000f, 300.000000f, 0, -1);
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.160000f, 6.000000f, 30.000000f, 160.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(Object_handles[139], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.120000f, 3.000000f, 30.000000f, 120.000000f, 0, -1);
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.090000f, 3.000000f, 18.000000f, 300.000000f, 0, -1);
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.160000f, 5.000000f, 30.000000f, 160.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, 3.000000f, 20.000000f, 130.000000f, 0, -1);
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.120000f, 3.000000f, 35.000000f, 80.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.120000f, 3.000000f, 12.000000f, 130.000000f, 0, -1);
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.140000f, 3.000000f, 30.000000f, 80.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.120000f, 4.000000f, 25.000000f, 80.000000f, 0, -1);
					aTurnOnSpew(Object_handles[139], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.300000f, 0.120000f, 4.000000f, 10.000000f, 120.000000f, 0, -1);
