...
int	STDCALL GetCOScriptList( int **list, int **id_list )
{
	...
	static int cust_id_list[66] = { 
		...
		ID_CUSTOM_OBJECT_0835,
		ID_CUSTOM_OBJECT_1816,
		ID_CUSTOM_OBJECT_0825,
		ID_CUSTOM_OBJECT_084B,
		ID_CUSTOM_OBJECT_0839,
		ID_CUSTOM_OBJECT_1847,
		ID_CUSTOM_OBJECT_10C6,
		ID_CUSTOM_OBJECT_11F6,
		ID_CUSTOM_OBJECT_0A24,
		ID_CUSTOM_OBJECT_0A23,
		ID_CUSTOM_OBJECT_18A0,
		ID_CUSTOM_OBJECT_1090,
		ID_CUSTOM_OBJECT_18B0,
		ID_CUSTOM_OBJECT_08B6,
		ID_CUSTOM_OBJECT_08B5,
		ID_CUSTOM_OBJECT_08A9,
		ID_CUSTOM_OBJECT_10BD,
		ID_CUSTOM_OBJECT_08BE,
		ID_CUSTOM_OBJECT_105C,
		ID_CUSTOM_OBJECT_084D,
		ID_CUSTOM_OBJECT_295F,
		ID_CUSTOM_OBJECT_182C,
		ID_CUSTOM_OBJECT_2023,
		ID_CUSTOM_OBJECT_0840,
		ID_CUSTOM_OBJECT_30C7,
		ID_CUSTOM_OBJECT_0A5C,
		ID_CUSTOM_OBJECT_1134,
		ID_CUSTOM_OBJECT_0887,
		ID_CUSTOM_OBJECT_095B,
		ID_CUSTOM_OBJECT_295E,
		ID_CUSTOM_OBJECT_09F0,
		ID_CUSTOM_OBJECT_09D3,
		ID_CUSTOM_OBJECT_087D,
		ID_CUSTOM_OBJECT_0869,
		ID_CUSTOM_OBJECT_09F9,
		ID_CUSTOM_OBJECT_193B,
		ID_CUSTOM_OBJECT_0A08,
		ID_CUSTOM_OBJECT_0A14,
		ID_CUSTOM_OBJECT_08CB,
		ID_CUSTOM_OBJECT_0A35,
		ID_CUSTOM_OBJECT_9233,
		ID_CUSTOM_OBJECT_092B,
		ID_CUSTOM_OBJECT_0929,
		ID_CUSTOM_OBJECT_112A,
		ID_CUSTOM_OBJECT_0928,
		...
		case EVT_LEVELSTART:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(Object_handles[19], -1, 8, 0.000000f, 0.000000f, 65536, 0, 4.500000f, 0.100000f, -1.000000f, 14.000000f, 18.000000f, 1, 0);
					aTurnOnSpew(Object_handles[20], -1, 8, 0.000000f, 0.000000f, 65536, 0, 4.500000f, 0.100000f, -1.000000f, 14.000000f, 18.000000f, 1, 1);
					aTurnOnSpew(Object_handles[21], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, -1.000000f, 9.000000f, 80.000000f, 0, 2);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					...
					if((event_data->id==0) && ((ScriptActionCtr_010 > 0)==false))
					{
						...
						aTurnOnSpew(Object_handles[3], -1, 6, 0.000000f, 0.000000f, 65536, 0, 0.200000f, 0.090000f, 6.000000f, 100.000000f, 190.000000f, 0, -1);
						aTurnOnSpew(Object_handles[4], -1, 6, 0.000000f, 0.000000f, 65536, 0, 0.200000f, 0.090000f, 6.000000f, 90.000000f, 190.000000f, 0, -1);
						aMiscViewerShake(70.000000f);
						aTurnOnSpew(Object_handles[5], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.900000f, 1.200000f, 4.000000f, 100.000000f, 1, 6);
						aTurnOnSpew(Object_handles[6], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 1.000000f, 1.000000f, 4.000000f, 90.000000f, 1, 6);
						...
						aTurnOnSpew(Object_handles[10], -1, 6, 0.000000f, 0.000000f, 65536, 0, 0.200000f, 0.090000f, 6.000000f, 90.000000f, 190.000000f, 0, -1);
					}
				...
				if(event_data->id==5)
				{
					if(qMathAddInt(qMathAddInt(qObjCountTypeID(2, "stormtrooperred"), qObjCountTypeID(2, "stormtrooperwhite")), qObjCountTypeID(2, "stormtroopergreen"))<=3)
					{
		...
		case EVT_CREATED:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[26], -1, 7, 0.000000f, 0.000000f, 65536, 0, 2.500000f, 0.150000f, -1.000000f, 5.000000f, 20.000000f, 1, -1);
		...
		case EVT_CREATED:
			{
				...
				if(1)
				{
					aTurnOnSpew(data->me_handle, 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 5.000000f, 60.000000f, 1, -1);
		...
		case EVT_CREATED:
			{
				...
				if(1)
				{
					aTurnOnSpew(data->me_handle, -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 5.000000f, 60.000000f, 1, -1);
		...
		case EVT_CREATED:
			{
				...
				if(1)
				{
					aTurnOnSpew(data->me_handle, -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.150000f, -1.000000f, 10.000000f, 50.000000f, 1, -1);
		...
		case EVT_CREATED:
			{
				...
				if(1)
				{
					aTurnOnSpew(data->me_handle, -1, 7, 0.000000f, 0.000000f, 65536, 0, 0.900000f, 0.150000f, -1.000000f, 14.000000f, 30.000000f, 1, -1);
		...
		case EVT_COLLIDE:
			{
				...
				if((ScriptActionCtr_034 < 1) && ((qObjIsPlayerOrPlayerWeapon(event_data->it_handle)==true) && (qUserFlag(0)==false)))
				{
		...
		case EVT_USE:
			{
				...
				if(qObjIsPlayer(event_data->it_handle)==true)
				{
					...
					aAddObjectToInventory(data->me_handle, event_data->it_handle, 0);
					aShowHUDMessageI(Message_strings[26], qMathAddInt(qMathAddInt(qObjCountTypeID(2, "stormtrooperred"), qObjCountTypeID(2, "stormtroopergreen")), qObjCountTypeID(2, "stormtrooperwhite")));
		...
		case EVT_COLLIDE:
			{
				...
				if(qObjIsPlayerWeapon(event_data->it_handle)==true)
				{
					aTurnOnSpew(Object_handles[77], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.070000f, 10.000000f, 2.200000f, 90.000000f, 1, -1);
