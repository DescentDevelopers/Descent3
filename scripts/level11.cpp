...
int	STDCALL GetCOScriptList( int **list, int **id_list )
{
	...
	static int cust_id_list[112] = { 
		ID_CUSTOM_OBJECT_0985,
		ID_CUSTOM_OBJECT_0942,
		ID_CUSTOM_OBJECT_0941,
		ID_CUSTOM_OBJECT_092B,
		ID_CUSTOM_OBJECT_093E,
		ID_CUSTOM_OBJECT_0940,
		ID_CUSTOM_OBJECT_093F,
		ID_CUSTOM_OBJECT_0954,
		ID_CUSTOM_OBJECT_3951,
		ID_CUSTOM_OBJECT_08CF,
		ID_CUSTOM_OBJECT_08CC,
		ID_CUSTOM_OBJECT_10D2,
		ID_CUSTOM_OBJECT_0943,
		ID_CUSTOM_OBJECT_0944,
		ID_CUSTOM_OBJECT_08CE,
		ID_CUSTOM_OBJECT_0952,
		ID_CUSTOM_OBJECT_0953,
		ID_CUSTOM_OBJECT_1826,
		ID_CUSTOM_OBJECT_1180,
		ID_CUSTOM_OBJECT_1919,
		ID_CUSTOM_OBJECT_0911,
		ID_CUSTOM_OBJECT_310B,
		ID_CUSTOM_OBJECT_10D0,
		ID_CUSTOM_OBJECT_08D1,
		ID_CUSTOM_OBJECT_0A12,
		ID_CUSTOM_OBJECT_097C,
		ID_CUSTOM_OBJECT_097D,
		ID_CUSTOM_OBJECT_097E,
		ID_CUSTOM_OBJECT_097B,
		ID_CUSTOM_OBJECT_097A,
		ID_CUSTOM_OBJECT_0976,
		ID_CUSTOM_OBJECT_0977,
		ID_CUSTOM_OBJECT_0978,
		ID_CUSTOM_OBJECT_0979,
		ID_CUSTOM_OBJECT_0975,
		ID_CUSTOM_OBJECT_0974,
		ID_CUSTOM_OBJECT_0973,
		ID_CUSTOM_OBJECT_0972,
		ID_CUSTOM_OBJECT_0971,
		ID_CUSTOM_OBJECT_0970,
		ID_CUSTOM_OBJECT_096F,
		ID_CUSTOM_OBJECT_096E,
		ID_CUSTOM_OBJECT_1182,
		ID_CUSTOM_OBJECT_1181,
		ID_CUSTOM_OBJECT_110A,
		ID_CUSTOM_OBJECT_1109,
		ID_CUSTOM_OBJECT_1108,
		ID_CUSTOM_OBJECT_10DF,
		ID_CUSTOM_OBJECT_10DE,
		ID_CUSTOM_OBJECT_10DD,
		ID_CUSTOM_OBJECT_10DC,
		ID_CUSTOM_OBJECT_10DB,
		ID_CUSTOM_OBJECT_10D6,
		ID_CUSTOM_OBJECT_10D7,
		ID_CUSTOM_OBJECT_10D8,
		ID_CUSTOM_OBJECT_116C,
		ID_CUSTOM_OBJECT_10D5,
		ID_CUSTOM_OBJECT_10DA,
		ID_CUSTOM_OBJECT_18D4,
		ID_CUSTOM_OBJECT_18CD,
		ID_CUSTOM_OBJECT_18D3,
		ID_CUSTOM_OBJECT_10EA,
		ID_CUSTOM_OBJECT_18EC,
		ID_CUSTOM_OBJECT_10EB,
		ID_CUSTOM_OBJECT_18E6,
		ID_CUSTOM_OBJECT_10E8,
		ID_CUSTOM_OBJECT_10E9,
		ID_CUSTOM_OBJECT_10E7,
		ID_CUSTOM_OBJECT_10E3,
		ID_CUSTOM_OBJECT_10E5,
		ID_CUSTOM_OBJECT_10E4,
		ID_CUSTOM_OBJECT_18E2,
		ID_CUSTOM_OBJECT_10EE,
		ID_CUSTOM_OBJECT_18ED,
		ID_CUSTOM_OBJECT_10F6,
		ID_CUSTOM_OBJECT_10F7,
		ID_CUSTOM_OBJECT_10F5,
		ID_CUSTOM_OBJECT_10F8,
		ID_CUSTOM_OBJECT_18EF,
		...
		ID_CUSTOM_OBJECT_10FE,
		ID_CUSTOM_OBJECT_10FF,
		ID_CUSTOM_OBJECT_20F1,
		ID_CUSTOM_OBJECT_10F4,
		ID_CUSTOM_OBJECT_10F3,
		ID_CUSTOM_OBJECT_10F2,
		ID_CUSTOM_OBJECT_1101,
		ID_CUSTOM_OBJECT_1100,
		ID_CUSTOM_OBJECT_1102,
		ID_CUSTOM_OBJECT_1103,
		ID_CUSTOM_OBJECT_1106,
		ID_CUSTOM_OBJECT_1107,
		ID_CUSTOM_OBJECT_1104,
		ID_CUSTOM_OBJECT_1105,
		ID_CUSTOM_OBJECT_0A53,
		ID_CUSTOM_OBJECT_080F,
		ID_CUSTOM_OBJECT_096A,
		ID_CUSTOM_OBJECT_0A66,
		ID_CUSTOM_OBJECT_0A65,
		ID_CUSTOM_OBJECT_0A64,
		ID_CUSTOM_OBJECT_0A63,
		ID_CUSTOM_OBJECT_0A62,
		ID_CUSTOM_OBJECT_1221,
		ID_CUSTOM_OBJECT_096B,
		ID_CUSTOM_OBJECT_0969,
		ID_CUSTOM_OBJECT_1A7F,
		ID_CUSTOM_OBJECT_227E
	};
		...
		case EVT_INTERVAL:
			{
				...
				if((ScriptActionCtr_027 < 1) && (((ScriptActionCtr_056 > 0)==true) && ((ScriptActionCtr_055 > 0)==true) && ((ScriptActionCtr_054 > 0)==true)))
				{
		...
		case EVT_COLLIDE:
			{
				...
				if((ScriptActionCtr_002 < 1) && (qObjIsPlayerWeapon(event_data->it_handle)==true))
				{
					...
					aTurnOnSpew(data->me_handle, 0, 8, 0.000000f, 0.000000f, 65536, 0, 1.600000f, 0.120000f, 20.000000f, 3.000000f, 15.000000f, 1, -1);
					aTurnOnSpew(data->me_handle, 1, 8, 0.000000f, 0.000000f, 65536, 0, 1.600000f, 0.120000f, 20.000000f, 3.000000f, 15.000000f, 1, -1);
		...
		case EVT_CREATED:
			{
				...
				if(1)
				{
					aTurnOnSpew(data->me_handle, -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.700000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 1, -1);
		...
		case EVT_INTERVAL:
			{
				...
				if((ScriptActionCtr_019 < 1) && ((qObjCanSeePlayer(65, data->me_handle, 240.000000f)==true) && ((ScriptActionCtr_131 > 0)==true)))
				{
		...
		case EVT_CREATED:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[125], -1, 16, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.070000f, -1.000000f, 3.000000f, 25.000000f, 0, 0);
					aTurnOnSpew(Object_handles[126], -1, 16, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.070000f, -1.000000f, 3.000000f, 25.000000f, 0, 1);
					aTurnOnSpew(Object_handles[127], -1, 16, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.070000f, -1.000000f, 3.000000f, 25.000000f, 0, 2);
		...
		case EVT_COLLIDE:
			{
				...
				if((ScriptActionCtr_119 < 1) && (1))
				{
					...
					aTurnOnSpew(Object_handles[120], -1, 16, 0.000000f, 0.000000f, 65536, 0, 1.400000f, 0.070000f, 30.000000f, 3.000000f, 25.000000f, 0, -1);
					aTurnOnSpew(Object_handles[121], -1, 16, 0.000000f, 0.000000f, 65536, 0, 1.400000f, 0.070000f, 30.000000f, 3.000000f, 25.000000f, 0, -1);
					aTurnOnSpew(Object_handles[122], -1, 16, 0.000000f, 0.000000f, 65536, 0, 1.400000f, 0.070000f, 30.000000f, 3.000000f, 25.000000f, 0, -1);
					aTurnOnSpew(Object_handles[123], -1, 16, 0.000000f, 0.000000f, 65536, 0, 1.400000f, 0.070000f, 30.000000f, 3.000000f, 25.000000f, 0, -1);
		...
		case EVT_COLLIDE:
			{
				...
				if((ScriptActionCtr_156 < 1) && ((qObjExists(Object_handles[3])==true) && ((ScriptActionCtr_132 > 0)==false)))
				{
		...
		case EVT_COLLIDE:
			{
				...
				if((ScriptActionCtr_132 < 1) && ((qObjExists(Object_handles[3])==true) && ((ScriptActionCtr_156 > 0)==false)))
				{
					aCinematicSimple(Path_indexes[8], Message_strings[12], Object_handles[3], 10.000000f, 1);
