...
int	STDCALL GetCOScriptList( int **list, int **id_list )
{
	...
	static int cust_id_list[7] = { 
		ID_CUSTOM_OBJECT_200D,
		ID_CUSTOM_OBJECT_281B,
		ID_CUSTOM_OBJECT_3816,
		ID_CUSTOM_OBJECT_1012,
		ID_CUSTOM_OBJECT_181C,
		...
		case EVT_MATCEN_CREATE:
			{
				...
				if(event_data->id==Matcen_indexes[2])
				{
					...
					if(((qRandomChance(0.500000f)==true) && (qObjShields(Object_handles[0])>0.000000f)) || ((qObjShields(Object_handles[1])<=0.000000f) && (qObjShields(Object_handles[2])<=0.000000f)))
					{
				...
				if(event_data->id==Matcen_indexes[0])
				{
					...
					if(((qRandomChance(0.500000f)==true) && (qObjShields(Object_handles[3])>0.000000f)) || (qObjShields(Object_handles[2])<=0.000000f))
					{
		...
		case EVT_COLLIDE:
			{
				...
				{
					aTurnOnSpew(Object_handles[6], -1, 2, 0.000000f, 0.000000f, 65536, 0, 4.000000f, 0.150000f, -1.000000f, 15.000000f, 60.000000f, 1, -1);
					aTurnOnSpew(Object_handles[7], -1, 8, 0.000000f, 0.000000f, 65536, 0, 4.000000f, 0.150000f, -1.000000f, 15.000000f, 60.000000f, 1, -1);
					aTurnOnSpew(Object_handles[7], -1, 2, 0.000000f, 0.000000f, 65536, 0, 4.000000f, 0.150000f, -1.000000f, 15.000000f, 60.000000f, 1, -1);
					aTurnOnSpew(Object_handles[8], -1, 2, 0.000000f, 0.000000f, 65536, 0, 4.000000f, 0.150000f, -1.000000f, 15.000000f, 60.000000f, 1, -1);
					aTurnOnSpew(Object_handles[9], -1, 2, 0.000000f, 0.000000f, 65536, 0, 4.000000f, 0.150000f, -1.000000f, 15.000000f, 60.000000f, 1, -1);
					aTurnOnSpew(Object_handles[10], -1, 2, 0.000000f, 0.000000f, 65536, 0, 4.000000f, 0.150000f, -1.000000f, 15.000000f, 60.000000f, 1, -1);
					aTurnOnSpew(Object_handles[11], -1, 2, 0.000000f, 0.000000f, 65536, 0, 4.000000f, 0.150000f, -1.000000f, 15.000000f, 60.000000f, 1, -1);
					aTurnOnSpew(Object_handles[12], -1, 4, 0.000000f, 0.000000f, 65536, 0, 4.000000f, 0.150000f, -1.000000f, 15.000000f, 60.000000f, 1, -1);
					aTurnOnSpew(Object_handles[13], -1, 3, 0.000000f, 0.000000f, 65536, 0, 4.000000f, 0.150000f, -1.000000f, 15.000000f, 60.000000f, 1, -1);
