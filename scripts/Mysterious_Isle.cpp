...
$$END
*/
void aStartErruptionSound()
{
	Erruption_sound = Sound_Play2d(OBJECT_HANDLE_NONE, Sound_FindId("ErruptionLoop"));
}
		...
		case EVT_LEVELSTART:
			{
				...
				if(1)
				{
					aAIGoalFollowPathSimple(qCustomCreateObjectAtObject(2, qCustomGetID(Message_strings[1]), Object_handles[13]), Path_indexes[0], 8392965, -1, 3);
		...
		case EVT_CREATED:
			{
				...
				if(1)
				{
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 0.500000f, 0.050000f, -1.000000f, 4.000000f, 30.000000f, 1, -1);
		...
		case EVT_CREATED:
			{
				...
				if(1)
				{
					aTurnOnSpew(data->me_handle, -1, 2, 0.000000f, 0.000000f, 65536, 0, 0.400000f, 0.060000f, -1.000000f, 4.000000f, 25.000000f, 1, -1);
		...
		case EVT_COLLIDE:
			{
				...
				if(qUserVarValue(0)==0.000000f)
				{
					...
					aObjPlayAnim(data->me_handle, 0, 1, 1.000000f, 0);
					aTurnOnSpew(Object_handles[16], -1, 8, 0.000000f, 0.000000f, 65536, 0, 12.000000f, 0.170000f, 30.000000f, 60.000000f, 65.000000f, 1, -1);
					aTurnOnSpew(Object_handles[17], -1, 7, 0.000000f, 0.000000f, 65536, 0, 10.000000f, 0.100000f, 30.000000f, 50.000000f, 65.000000f, 1, -1);
