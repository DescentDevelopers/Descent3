...
int16_t LevelScript_0000::CallEvent(int event, tOSIRISEventInfo *data) {
  ...
  case EVT_LEVELSTART: {
    ...
    if (1) {
      ...
      aObjSaveHandle(qCustomCreateObjectAtObject(2, qCustomGetID(TXT("HackBot")), Object_handles[0]), 0);
      aObjSaveHandle(qCustomCreateObjectAtObject(2, qCustomGetID(TXT("HackBot")), Object_handles[1]), 1);
      aObjSaveHandle(qCustomCreateObjectAtObject(2, qCustomGetID(TXT("HackBot")), Object_handles[2]), 2);
      aObjSaveHandle(qCustomCreateObjectAtObject(2, qCustomGetID(TXT("HackBot")), Object_handles[3]), 3);
    ...
    if (1) {
      aAIGoalFollowPathSimple(qCustomCreateObjectAtObject(2, qCustomGetID(TXT("Message1")), Object_handles[13]),
