...
int	STDCALL GetCOScriptList( int **list, int **id_list )
{
	...
	static int cust_id_list[10] = { 
		ID_CUSTOM_OBJECT_3855,
		ID_CUSTOM_OBJECT_10DC,
		ID_CUSTOM_OBJECT_10E0,
		ID_CUSTOM_OBJECT_10DF,
		ID_CUSTOM_OBJECT_08E8,
		ID_CUSTOM_OBJECT_584D,
		ID_CUSTOM_OBJECT_0816,
		ID_CUSTOM_OBJECT_100D,
		ID_CUSTOM_OBJECT_301B,
		...
		case EVT_LEVELSTART:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[2], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 0, 0);
					aTurnOnSpew(Object_handles[3], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 0, 1);
					aTurnOnSpew(Object_handles[4], -1, 8, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 0, 3);
					aTurnOnSpew(Object_handles[5], -1, 8, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 0, 2);
					aTurnOnSpew(Object_handles[6], -1, 8, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 0, 4);
					aTurnOnSpew(Object_handles[7], -1, 8, 0.000000f, 0.000000f, 65536, 0, 1.000000f, 0.150000f, -1.000000f, 4.000000f, 20.000000f, 0, 5);
		...
		case EVT_COLLIDE:
			{
				...
				if((ScriptActionCtr_031 < 1) && ((qObjIsPlayer(event_data->it_handle)==true) && ((ScriptActionCtr_005 > 0)==false)))
				{
		...
		case EVT_COLLIDE:
			{
				...
				if((ScriptActionCtr_005 < 1) && ((qObjIsPlayer(event_data->it_handle)==true) && ((ScriptActionCtr_031 > 0)==false)))
				{
					aGoalCompleted(Goal_indexes[4], 1);
					aObjDestroy(Object_handles[37]);
					aStartEndlevelSequencePath(Path_indexes[0], Path_indexes[1], 10.000000f, Message_strings[5]);
		...
		case EVT_COLLIDE:
			{
				...
				if(1)
				{
					...
					aTurnOnSpew(Object_handles[8], 0, 2, 0.000000f, 0.000000f, 65536, 0, 2.000000f, 0.150000f, -1.000000f, 6.000000f, 30.000000f, 0, 6);
					aTurnOnSpew(Object_handles[9], 0, 2, 0.000000f, 0.000000f, 65536, 0, 2.000000f, 0.150000f, -1.000000f, 6.000000f, 30.000000f, 0, 7);
					aTurnOnSpew(Object_handles[10], 0, 2, 0.000000f, 0.000000f, 65536, 0, 2.000000f, 0.150000f, -1.000000f, 6.000000f, 30.000000f, 0, 8);
					aTurnOnSpew(Object_handles[11], 0, 2, 0.000000f, 0.000000f, 65536, 0, 2.000000f, 0.150000f, -1.000000f, 6.000000f, 30.000000f, 0, 9);
					aTurnOnSpew(Object_handles[8], 0, 2, 0.000000f, 0.000000f, 0, 1, 2.000000f, 0.500000f, -1.000000f, 6.000000f, 30.000000f, 0, 10);
					aTurnOnSpew(Object_handles[9], 0, 2, 0.000000f, 0.000000f, 0, 1, 2.000000f, 0.500000f, -1.000000f, 6.000000f, 30.000000f, 0, 11);
					aTurnOnSpew(Object_handles[10], 0, 2, 0.000000f, 0.000000f, 0, 1, 2.000000f, 0.500000f, -1.000000f, 6.000000f, 30.000000f, 0, 12);
					aTurnOnSpew(Object_handles[11], 0, 2, 0.000000f, 0.000000f, 0, 1, 2.000000f, 0.500000f, -1.000000f, 6.000000f, 30.000000f, 0, 13);
					aUserFlagSet(6, 1);
