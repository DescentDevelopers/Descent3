		...
		case EVT_LEVELSTART:
			{
				...
				{
					aLightningCreate(Object_handles[1], Object_handles[2], 999999995904.000000f, 6.000000f, 1, Texture_indexes[2], 1.000000f, 1, 222, 255, 222, 0);
					aLightningCreate(Object_handles[1], Object_handles[3], 999999995904.000000f, 6.000000f, 1, Texture_indexes[2], 1.000000f, 1, 222, 255, 222, 0);
					aLightningCreate(Object_handles[1], Object_handles[4], 999999995904.000000f, 6.000000f, 1, Texture_indexes[2], 1.000000f, 1, 222, 255, 222, 0);
					aLightningCreate(Object_handles[2], Object_handles[3], 999999995904.000000f, 6.000000f, 1, Texture_indexes[2], 1.000000f, 1, 222, 255, 222, 0);
					aLightningCreate(Object_handles[2], Object_handles[4], 999999995904.000000f, 6.000000f, 1, Texture_indexes[2], 1.000000f, 1, 222, 255, 222, 0);
					aLightningCreate(Object_handles[2], Object_handles[5], 999999995904.000000f, 6.000000f, 1, Texture_indexes[2], 1.000000f, 1, 222, 255, 222, 0);
					aLightningCreate(Object_handles[3], Object_handles[4], 999999995904.000000f, 6.000000f, 1, Texture_indexes[2], 1.000000f, 1, 222, 255, 222, 0);
					aLightningCreate(Object_handles[3], Object_handles[5], 999999995904.000000f, 6.000000f, 1, Texture_indexes[2], 1.000000f, 1, 222, 255, 222, 0);
					aLightningCreate(Object_handles[3], Object_handles[1], 999999995904.000000f, 6.000000f, 1, Texture_indexes[2], 1.000000f, 1, 222, 255, 222, 0);
					aLightningCreate(Object_handles[4], Object_handles[5], 10000000000.000000f, 6.000000f, 1, Texture_indexes[2], 1.000000f, 1, 222, 255, 222, 0);
					aLightningCreate(Object_handles[4], Object_handles[1], 10000000000.000000f, 6.000000f, 1, Texture_indexes[2], 1.000000f, 1, 222, 255, 222, 0);
					aLightningCreate(Object_handles[4], Object_handles[2], 10000000000.000000f, 6.000000f, 1, Texture_indexes[2], 1.000000f, 1, 222, 255, 222, 0);
					aLightningCreate(Object_handles[5], Object_handles[1], 10000000000.000000f, 6.000000f, 1, Texture_indexes[2], 1.000000f, 1, 222, 255, 222, 0);
					aLightningCreate(Object_handles[5], Object_handles[2], 10000000000.000000f, 6.000000f, 1, Texture_indexes[2], 1.000000f, 1, 222, 255, 222, 0);
					aLightningCreate(Object_handles[5], Object_handles[3], 10000000000.000000f, 6.000000f, 1, Texture_indexes[2], 1.000000f, 1, 222, 255, 222, 0);
		...
		case EVT_TIMER:
			{
				...
				if((ScriptActionCtr_017 < 1) && (event_data->id==6))
				{
					...
					aTurnOnSpew(Object_handles[7], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, 30.000000f, 4.000000f, 20.000000f, 1, -1);
					aLightningCreate(Object_handles[7], Object_handles[6], 999999995904.000000f, 6.000000f, 1, Texture_indexes[2], 1.000000f, 1, 222, 255, 222, 0);
					aLightningCreate(Object_handles[1], Object_handles[6], 999999995904.000000f, 6.000000f, 1, Texture_indexes[2], 1.000000f, 1, 222, 255, 222, 0);
					aLightningCreate(Object_handles[2], Object_handles[6], 999999995904.000000f, 6.000000f, 1, Texture_indexes[2], 1.000000f, 1, 222, 255, 222, 0);
					aLightningCreate(Object_handles[3], Object_handles[6], 999999995904.000000f, 6.000000f, 1, Texture_indexes[2], 1.000000f, 1, 222, 255, 222, 0);
					aLightningCreate(Object_handles[4], Object_handles[6], 999999995904.000000f, 6.000000f, 1, Texture_indexes[2], 1.000000f, 1, 222, 255, 222, 0);
					aLightningCreate(Object_handles[5], Object_handles[6], 999999995904.000000f, 6.000000f, 1, Texture_indexes[2], 1.000000f, 1, 222, 255, 222, 0);
					aCancelTimer(5);
					aCancelTimer(4);
