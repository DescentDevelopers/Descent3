...
int	STDCALL GetCOScriptList( int **list, int **id_list )
{
	...
	static int cust_id_list[5] = { 
		ID_CUSTOM_OBJECT_0877,
		ID_CUSTOM_OBJECT_086B,
		ID_CUSTOM_OBJECT_0871,
		ID_CUSTOM_OBJECT_1002,
		ID_CUSTOM_OBJECT_400A
	};
		...
		case EVT_LEVELSTART:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[16], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 5.000000f, 15.000000f, 0, -1);
					aTurnOnSpew(Object_handles[17], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 5.000000f, 15.000000f, 0, -1);
					aTurnOnSpew(Object_handles[18], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 5.000000f, 15.000000f, 0, -1);
