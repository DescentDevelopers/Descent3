...
int	STDCALL GetCOScriptList( int **list, int **id_list )
{
	...
	static int cust_id_list[35] = { 
		...
		ID_CUSTOM_OBJECT_306C,
		ID_CUSTOM_OBJECT_1869,
		ID_CUSTOM_OBJECT_186A,
		...
		ID_CUSTOM_OBJECT_3072,
		ID_CUSTOM_OBJECT_406F,
		ID_CUSTOM_OBJECT_0B3C,
		ID_CUSTOM_OBJECT_1338,
		ID_CUSTOM_OBJECT_1337,
		ID_CUSTOM_OBJECT_1339,
		ID_CUSTOM_OBJECT_133A,
		ID_CUSTOM_OBJECT_1B35,
		ID_CUSTOM_OBJECT_1B34,
		ID_CUSTOM_OBJECT_1B41,
		ID_CUSTOM_OBJECT_1336,
		ID_CUSTOM_OBJECT_6856,
		ID_CUSTOM_OBJECT_0B40,
		ID_CUSTOM_OBJECT_0B30,
		ID_CUSTOM_OBJECT_0B31,
		ID_CUSTOM_OBJECT_1B2E,
		ID_CUSTOM_OBJECT_0B2F,
		ID_CUSTOM_OBJECT_0B32,
		ID_CUSTOM_OBJECT_232D,
		ID_CUSTOM_OBJECT_0B3F,
		ID_CUSTOM_OBJECT_0B3B,
		ID_CUSTOM_OBJECT_0B3D,
		ID_CUSTOM_OBJECT_0B3E,
		ID_CUSTOM_OBJECT_1195
	};
		...
		case EVT_LEVELSTART:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[52], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.400000f, 0.140000f, -1.000000f, 2.000000f, 15.000000f, 0, -1);
					aTurnOnSpew(Object_handles[53], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.400000f, 0.140000f, -1.000000f, 4.000000f, 25.000000f, 0, -1);
					aTurnOnSpew(Object_handles[54], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.400000f, 0.140000f, -1.000000f, 5.000000f, 30.000000f, 0, -1);
					aTurnOnSpew(Object_handles[55], -1, 2, 0.000000f, 0.000000f, 65536, 0, 1.400000f, 0.140000f, -1.000000f, 3.000000f, 20.000000f, 0, -1);
					aTurnOnSpew(Object_handles[56], 0, 8, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, -1.000000f, 2.400000f, 25.000000f, 0, -1);
					aTurnOnSpew(Object_handles[57], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.400000f, 0.140000f, -1.000000f, 3.000000f, 15.000000f, 0, -1);
					aTurnOnSpew(Object_handles[58], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.400000f, 0.140000f, -1.000000f, 3.000000f, 20.000000f, 0, -1);
					aTurnOnSpew(Object_handles[59], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.400000f, 0.140000f, -1.000000f, 3.000000f, 20.000000f, 0, -1);
					aTurnOnSpew(Object_handles[60], 0, 7, 1.000000f, 0.010000f, 65664, 0, 1.400000f, 0.130000f, -1.000000f, 3.000000f, 25.000000f, 0, -1);
					aTurnOnSpew(Object_handles[61], 0, 7, 1.000000f, 0.010000f, 65664, 0, 1.400000f, 0.130000f, -1.000000f, 3.000000f, 25.000000f, 0, -1);
					aTurnOnSpew(Object_handles[62], 0, 7, 1.000000f, 0.010000f, 65664, 0, 1.400000f, 0.130000f, -1.000000f, 3.000000f, 25.000000f, 0, -1);
					aTurnOnSpew(Object_handles[63], 0, 7, 1.000000f, 0.010000f, 65664, 0, 1.400000f, 0.130000f, -1.000000f, 3.000000f, 25.000000f, 0, -1);
					aTurnOnSpew(Object_handles[64], 0, 7, 1.000000f, 0.010000f, 65664, 0, 1.400000f, 0.130000f, -1.000000f, 3.000000f, 20.000000f, 0, -1);
					aTurnOnSpew(Object_handles[65], 0, 7, 1.000000f, 0.010000f, 65664, 0, 1.400000f, 0.130000f, -1.000000f, 3.000000f, 20.000000f, 0, -1);
				...
				if(1)
				{
					...
					aTurnOnSpew(Object_handles[78], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.120000f, -1.000000f, 2.000000f, 15.000000f, 0, -1);
					aTurnOnSpew(Object_handles[79], 0, 8, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.120000f, -1.000000f, 2.000000f, 15.000000f, 0, -1);
					aTurnOnSpew(Object_handles[77], 0, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.120000f, -1.000000f, 2.000000f, 15.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[40], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, -1.000000f, 2.500000f, 18.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[41], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, -1.000000f, 2.500000f, 18.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[42], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, -1.000000f, 2.500000f, 18.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[43], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, -1.000000f, 2.500000f, 18.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[44], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, -1.000000f, 2.500000f, 18.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[45], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, -1.000000f, 2.500000f, 18.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[46], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, -1.000000f, 2.500000f, 18.000000f, 0, -1);
		...
		case EVT_TIMER:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[47], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.200000f, 0.100000f, -1.000000f, 2.500000f, 18.000000f, 0, -1);
