...
int16_t LevelScript_0000::CallEvent(int event, tOSIRISEventInfo *data) {
  ...
  case EVT_LEVELSTART: {
    ...
    // Script 071: IntroCam
    if (1 == true) {
      aCinematicIntro(Path_indexes[0], TXT("IntroMessage"), Object_handles[9], Path_indexes[1], 15.000000f);
  ...
  case EVT_TIMER: {
    ...
    if (event_data->id == 2) {
      aShowHUDMessage(TXT("AlienCuplinks"));
    ...
    if ((ScriptActionCtr_044 < 1) && (event_data->id == 6)) {
      ...
      aCinematicSimple(Path_indexes[3], TXT("DestroyThese"), Object_handles[51], 10.000000f);
    ...
    if ((ScriptActionCtr_046 < 1) && (event_data->id == 4)) {
      ...
      aStartEndlevelSequencePath(Path_indexes[7], Path_indexes[8], 8.000000f, TXT("EndLevel"));
  ...
  case EVT_COLLIDE: {
    ...
    if ((ScriptActionCtr_016 < 1) && (qObjIsPlayer(event_data->it_handle) == true)) {
      if ((ScriptActionCtr_015 > 0) == true) {
        ...
        aShowHUDMessage(TXT("2KeyCards"));
      } else {
        aShowHUDMessage(TXT("1KeyCard"));
      }
  ...
  case EVT_COLLIDE: {
    ...
    if ((ScriptActionCtr_028 < 1) && (1)) {
      ...
      if ((ScriptActionCtr_029 > 0) == true) {
        ...
        aShowHUDMessage(TXT("TwoSwitchUnlock"));
        aDoorLockUnlock(0, Door_handles[2]);
        aDoorSetPos(Door_handles[2], 1.000000f);
      } else {
        aShowHUDMessage(TXT("TwoSwitchFirst"));
      }
...
int16_t CustomObjectScript_0B3C::CallEvent(int event, tOSIRISEventInfo *data) {
  ...
  case EVT_CHILD_DIED: {
    ...
    if (1) {
      ...
      aShowHUDMessage(TXT("PowerCupLink"));
...
int16_t TriggerScript_0014::CallEvent(int event, tOSIRISEventInfo *data) {
  ...
  case EVT_COLLIDE: {
    ...
    if ((ScriptActionCtr_042 < 1) && ((ScriptActionCtr_031 > 0) == true)) {
      ...
      aCinematicSimple(Path_indexes[2], TXT("HeresVirus"), Object_handles[49], 10.000000f);
