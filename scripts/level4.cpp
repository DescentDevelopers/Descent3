...
int	STDCALL GetCOScriptList( int **list, int **id_list )
{
	...
	static int cust_id_list[4] = { 
		ID_CUSTOM_OBJECT_08B3,
		ID_CUSTOM_OBJECT_08AE,
		ID_CUSTOM_OBJECT_1213,
		...
		case EVT_LEVELSTART:
			{
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[21], -1, 2, 0.000000f, 0.000000f, 65536, 0, 2.000000f, 0.250000f, -1.000000f, 8.000000f, 15.000000f, 1, 0);
					aTurnOnSpew(Object_handles[22], -1, 2, 0.000000f, 0.000000f, 65536, 0, 2.000000f, 0.250000f, -1.000000f, 8.000000f, 15.000000f, 1, 1);
					aTurnOnSpew(Object_handles[23], -1, 2, 0.000000f, 0.000000f, 65536, 0, 2.000000f, 0.250000f, -1.000000f, 8.000000f, 15.000000f, 1, 2);
					aTurnOnSpew(Object_handles[24], -1, 2, 0.000000f, 0.000000f, 65536, 0, 2.000000f, 0.250000f, -1.000000f, 8.000000f, 15.000000f, 1, 3);
					aTurnOnSpew(Object_handles[25], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, 30.000000f, 4.000000f, 20.000000f, 0, 4);
					aTurnOnSpew(Object_handles[26], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, 30.000000f, 4.000000f, 20.000000f, 0, 5);
					aTurnOnSpew(Object_handles[27], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, 30.000000f, 4.000000f, 20.000000f, 0, 6);
					aTurnOnSpew(Object_handles[28], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, 30.000000f, 4.000000f, 20.000000f, 0, 7);
					aTurnOnSpew(Object_handles[29], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, 30.000000f, 4.000000f, 20.000000f, 0, 8);
				...
				if(1)
				{
					aTurnOnSpew(Object_handles[36], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 3.000000f, 30.000000f, 1, 9);
					aTurnOnSpew(Object_handles[37], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.500000f, 0.150000f, -1.000000f, 6.000000f, 40.000000f, 1, 9);
		...
		case EVT_AIN_GOALCOMPLETE:
			{
				...
				if((event_data->goal_uid==0) || (event_data->goal_uid==1) || (event_data->goal_uid==2) || (event_data->goal_uid==3))
				{
		...
		case EVT_USE:
			{
				...
				if(1)
				{
					if(qObjGetDistance(Object_handles[15], event_data->it_handle)<35.000000f)
					{
						...
						aLightningCreate(Object_handles[17], data->me_handle, 10.000000f, 3.000000f, 1, Texture_indexes[0], 1.000000f, 3, 115, 115, 255, 0);
						aLightningCreate(Object_handles[18], data->me_handle, 10.000000f, 3.000000f, 1, Texture_indexes[0], 1.000000f, 3, 115, 115, 255, 0);
						aLightningCreate(Object_handles[19], data->me_handle, 10.000000f, 3.000000f, 1, Texture_indexes[0], 1.000000f, 3, 115, 115, 255, 0);
						aLightningCreate(Object_handles[20], data->me_handle, 10.000000f, 3.000000f, 1, Texture_indexes[0], 1.000000f, 3, 115, 115, 255, 0);
					}
					else {
						aObjGhostSet(0, data->me_handle);
						aAddObjectToInventory(data->me_handle, event_data->it_handle, 0);
