...
//	virtual int InitSoundLib(oeApplication *sos, char mixer_type, char quality, bool f_kill_sound_list);
	...
	virtual void NewSoundList(unsigned short num_sounds, unsigned int *sound_offset_array,
	...
	virtual int PlaySound3d(play_information *play_info, int sound_uid, pos_state *cur_pos, float master_volume, bool f_looped, float reverb=0.5f); //, unsigned short frequency)
...
protected:
	...
	unsigned char	m_f_sound_lib_status;			// Paused or running							-- cmphack
