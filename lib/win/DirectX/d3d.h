...
DECLARE_INTERFACE_(IDirect3DDevice3, IUnknown) {
  ...
  (THIS_ D3DPRIMITIVETYPE, DWORD, LPD3DDRAWPRIMITIVESTRIDEDDATA, DWORD, LPWORD, DWORD, DWORD) PURE;
...
DECLARE_INTERFACE_(IDirect3DDevice7, IUnknown) {
  ...
  (THIS_ D3DPRIMITIVETYPE, LPDIRECT3DVERTEXBUFFER7, DWORD, DWORD, LPWORD, DWORD, DWORD) PURE;
  STDMETHOD(ComputeSphereVisibility)(THIS_ LPD3DVECTOR, LPD3DVALUE, DWORD, DWORD, LPDWORD) PURE;
...
DECLARE_INTERFACE_(IDirect3DVertexBuffer7, IUnknown) {
  ...
  (THIS_ DWORD, DWORD, DWORD, LPD3DDRAWPRIMITIVESTRIDEDDATA, DWORD, LPDIRECT3DDEVICE7, DWORD) PURE;
};
