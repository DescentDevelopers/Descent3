...
operator vec<T,N_DST,A_DST>()
{
	return *reinterpret_cast<vec<T,N_DST,A_DST>*>(this);
}
...
constexpr static inline const vec<T,N,A> id(ssize_t i = -1) { vec<T,N> dst = {}; dst[i % N] = (T)1; return dst; }
