...
bool UISnazzyTextItem::draw(int x, int y, tUIDrawClass draw_class)
{
	if (m_flags & UISNAZZYTEXTF_BLINKING) {
		...
		r2 = r+96; if (r2 >255) r2 = 255;
		g2 = g+96; if (g2 >255) g2 = 255;
		b2 = b+96; if (b2 >255) b2 = 255;
		r2 = r2 - r; g2 = g2 - g; b2 = b2 - b;
...
int UIBitmapItem::width()
{
	return (m_IsValid ? ui_GetBitmapWidth(this) : 0);
}


int UIBitmapItem::height()
{
	return (m_IsValid ? ui_GetBitmapHeight(this) : 0);
}
