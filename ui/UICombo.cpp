...
UIItem *UIComboBox::GetItem(int index) const
{
	return (index < m_nItems) ? m_ItemList[index] : NULL;
}
...
void UIComboBox::SetSelectChangeCallback(void (*fn)(int))
{
	selectchange_fn = fn;
}
