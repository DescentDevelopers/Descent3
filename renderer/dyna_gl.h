...
typedef void(GLFUNCCALL *glDrawPixels_fp )(GLsizei width,GLsizei height, GLenum format, GLenum type, const GLvoid *pixels);
...
typedef void(GLFUNCCALL *glTexImage2D_fp )(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels);
typedef void(GLFUNCCALL *glTexParameteri_fp )(GLenum target, GLenum pname, GLint param);
typedef void(GLFUNCCALL *glTexSubImage2D_fp )(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels);
...
typedef void(GLFUNCCALL *glBitmap_fp)( GLsizei width, GLsizei height,
...
module *LoadOpenGLDLL(char *dllname)
{
	...
	if(! dglNormalPointer) goto dll_error;
	...
	if(! dglDrawElements) goto dll_error;
	...
	if(! dglLoadMatrixf) goto dll_error;
