...
// some inlines to prevent macro craziness when using incrementers and dereferencing, and so I can use operator overloading 
inline unsigned short IntelSwapper(unsigned short a)
{
	return INTEL_SHORT(a);
}

inline short IntelSwapper(short a)
{
	return INTEL_SHORT(a);
}

inline unsigned int IntelSwapper(unsigned int a)
{
	return INTEL_INT(a);
}

inline int IntelSwapper(int a)
{
	return INTEL_INT(a);
}

inline unsigned long IntelSwapper(unsigned long a)
{
	return INTEL_INT(a);
}

inline long IntelSwapper(long a)
{
	return INTEL_INT(a);
}
