...
private:
  ...
  void SaveThemeFile();
  bool SaveDigitalStream(OSFArchive *osf, const CString &rawfilename, uint8_t compression, uint8_t format,
...
private:
  enum tSongProp { SONGPROP_FILE, SONGPROP_REPEAT, SONGPROP_ROOMLINK };
