...
void url_launch(char *url) {
  ...
  if (r < 32) {
    ...
    switch (r) {
    case 0:
      txt.LoadString(IDS_D3LAUNCH_URL_ERR1);
      break;
    case ERROR_BAD_FORMAT:
      txt.LoadString(IDS_D3LAUNCH_URL_ERR2);
      break;
    case SE_ERR_ACCESSDENIED:
      txt.LoadString(IDS_D3LAUNCH_URL_ERR3);
      break;
    case SE_ERR_ASSOCINCOMPLETE:
      txt.LoadString(IDS_D3LAUNCH_URL_ERR4);
      break;
    case SE_ERR_DDEBUSY:
      txt.LoadString(IDS_D3LAUNCH_URL_ERR5);
      break;
    case SE_ERR_DDEFAIL:
      txt.LoadString(IDS_D3LAUNCH_URL_ERR6);
      break;
    case SE_ERR_DDETIMEOUT:
      txt.LoadString(IDS_D3LAUNCH_URL_ERR7);
      break;
    case SE_ERR_DLLNOTFOUND:
      txt.LoadString(IDS_D3LAUNCH_URL_ERR8);
      break;
    case SE_ERR_OOM:
      txt.LoadString(IDS_D3LAUNCH_URL_ERR9);
      break;
    case SE_ERR_SHARE:
      txt.LoadString(IDS_D3LAUNCH_URL_ERR10);
      break;
    ...
    default:
      txt.LoadString(IDS_D3LAUNCH_URL_ERR12);
      break;
    }
...
BOOL GetBitmapAndPalette(LPCTSTR lpszResourceName, CBitmap *bitmap, CPalette *pal) {
  ...
  HBITMAP hBmp =
      (HBITMAP)::LoadImage(AfxGetResourceHandle(), lpszResourceName, IMAGE_BITMAP, 0, 0, LR_CREATEDIBSECTION);
...
bool GetDirectXVersionViaDLL(DWORD *version, DWORD *revision) {
  ...
  pfn_DirectXSetupGetVersion =
      (LPFN_DIRECTXSETUPGETVERSION)GetProcAddress(dsetup_dll_handle, "DirectXSetupGetVersionA");
