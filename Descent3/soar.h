...
extern  __declspec(dllexport) int SoarInit(void *TerrainList, int terrain_size, void *RoomList, int room_size, void *ObjectList, int object_size, void *FunctionList);
...
#define SoarInit(TerrainList,terrain_size,RoomList,room_size,ObjectList,object_size,FunctionList) do {} while (0)
#define SoarTick(FrameTime) do {} while (0)
#define SoarCreateAgent(Objnum,Flags) do {} while (0)
#define SoarClearAgent(Objnum,Flags) do {} while (0)
#define SoarDestroyAgent(Objnum,Flags) do {} while (0)
#define SoarEnd() do {} while (0)
