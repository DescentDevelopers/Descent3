...
//		path	- Initial path, will contain the chosen file/path on exit with true, must be at least _MAX_PATH in size
//		title	- Title of the dialog	
//		wildc	- semicolon (;) seperated list of wildcards to be shown
//		flags	- see header PFDF_ for flags
