...
bool taunt_ImportWave(char *wave_filename,char *outputfilename)
{
	...
	*temp_filename = *osftemp_filename = '\0';
	...
	if(wave_ret!=0){
		...
		switch(wave_ret){
		case 1:			TauntLastError = TAUNTIMPERR_NOTFOUND;	break;
		case 2:			TauntLastError = TAUNTIMPERR_NOTRIFF;	break;
		case 3:			TauntLastError = TAUNTIMPERR_NOTWAVE;	break;
		case 4:
		case 5:			TauntLastError = TAUNTIMPERR_INVALIDFILE;	break;
		case 6:			TauntLastError = TAUNTIMPERR_NOTSUPPORTED;	break;
		case 7:			TauntLastError = TAUNTIMPERR_INVALIDCHANNELS;	break;
		case 8:			TauntLastError = TAUNTIMPERR_INVALIDSAMPLES;	break;
		case 9:			TauntLastError = TAUNTIMPERR_INVALIDBITDEPTH;	break;
		case 10:		TauntLastError = TAUNTIMPERR_NODATA;			break;
		}
		ret = false;
		goto error;
	}
		...
		switch(ckid)
		{
			...
			case 0x61746164: 
				...
				if (bits_per_sample == 8) 
				{
					...
					if(aligned_size != cksize) memset(wave->sample_8bit + cksize, 128, num_needed);
				} 
				else 
				{
					int num_needed = 0;
