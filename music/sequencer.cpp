...
OutrageMusicSeq::music_stream *OutrageMusicSeq::AddToList(short region, short theme_type, int len, const music_ins *ins)
{
...
void OutrageMusicSeq::SetCurrentRegion(short region)
{
	m_curregion = region;	
}


short OutrageMusicSeq::GetCurrentRegion() const
{
	return m_curregion;
}
